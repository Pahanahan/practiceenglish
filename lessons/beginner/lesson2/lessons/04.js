...
const stringsArray2 = [stringChoice5, stringChoice6, stringChoice7];
const stringsArray3 = [
  stringChoice8,
  stringChoice9,
  stringChoice10,
...
const stringsArray7 = [stringChoice25, stringChoice26, stringChoice27];
const stringsArray8 = [
  stringChoice28,
  stringChoice29,
  stringChoice30,
...
const audio01 = new Audio("audio04/he_sees_this_problem.wav");
const audio02 = new Audio("audio04/she_understands_it.wav");
const audio03 = new Audio("audio04/i_like_it_very_much.wav");
const audio04 = new Audio("audio04/she_lives_very_far.wav");
const audio05 = new Audio("audio04/she_likes_this_game.wav");
const audio06 = new Audio("audio04/it_costs_twenty_euros.wav");
const audio07 = new Audio("audio04/she_makes_mistakes.wav");
const audio08 = new Audio("audio04/he_often_does_it.wav");
const audio09 = new Audio("audio04/he_usually_buys_these_tickets.wav");
