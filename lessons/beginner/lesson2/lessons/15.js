...
const audio01 = new Audio("audio15/she_always_watches_tv.wav");
const audio02 = new Audio("audio15/she_likes_this_idea.wav");
const audio03 = new Audio("audio15/i_see_it_really_helps_me.wav");
const audio04 = new Audio("audio15/i_think_he_works_very_well.wav");
const audio05 = new Audio("audio15/i_understand_why_it_happens.wav");
const audio06 = new Audio("audio15/she_likes_it.wav");
const audio07 = new Audio("audio15/he_likes_this_video.wav");
const audio08 = new Audio("audio15/they_often_tell_me_these_things.wav");
const audio09 = new Audio("audio15/sometimes_he_says_it.wav");
const audio10 = new Audio("audio15/he_often_tells_me_this_thing.wav");
