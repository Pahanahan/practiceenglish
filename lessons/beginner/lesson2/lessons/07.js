...
const audio01 = new Audio("audio07/he_usually_buys_these_tickets.wav");
const audio02 = new Audio("audio07/she_wants_it.wav");
const audio03 = new Audio("audio07/he_sees_this_mistake.wav");
const audio04 = new Audio("audio07/he_feels_better.wav");
const audio05 = new Audio("audio07/it_costs_less.wav");
