...
const stringsArray2 = [stringChoice4, stringChoice5];
const stringsArray3 = [stringChoice6, stringChoice7, stringChoice8];
const stringsArray4 = [
  stringChoice9,
  stringChoice10,
  stringChoice11,
...
const stringsArray5 = [stringChoice13, stringChoice14];
...
const audio01 = new Audio("audio04/she's_my_mother.wav");
const audio02 = new Audio("audio04/i'm_ok.wav");
const audio03 = new Audio("audio04/we're_at_home.wav");
const audio04 = new Audio("audio04/she's_seventy_years_old.wav");
const audio05 = new Audio("audio04/he's_seventy.wav");
