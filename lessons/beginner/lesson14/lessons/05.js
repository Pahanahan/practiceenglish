...
const audio01 = new Audio("audio05/she's_seventy_years_old.wav");
const audio02 = new Audio("audio05/i'm_ok.wav");
const audio03 = new Audio("audio05/he's_seventy.wav");
const audio04 = new Audio("audio05/she's_ok.wav");
const audio05 = new Audio("audio05/it's_very_far.wav");
const audio06 = new Audio("audio05/he's_eight.wav");
const audio07 = new Audio("audio05/it's_dangerous.wav");
const audio08 = new Audio("audio05/you're_very_hard-working.wav");
const audio09 = new Audio("audio05/i'm_fine.wav");
const audio10 = new Audio("audio05/she's_very_poor.wav");
const audio11 = new Audio("audio05/he's_single.wav");
const audio12 = new Audio("audio05/she's_american.wav");
const audio13 = new Audio("audio05/it's_so_far.wav");
const audio14 = new Audio("audio05/we're_at_home.wav");
const audio15 = new Audio("audio05/you're_very_smart.wav");

const answersArray = [
  ["She's seventy years old", "She's seventy"],
  ["I'm OK", "I'm OK"],
  ["He's seventy", "He's seventy"],
  ["She's OK", "She's OK"],
  ["It's very far", "It's very far"],
  ["He's eight", "He's eight"],
  ["It's dangerous", "It's dangerous"],
  ["You're very hard-working", "You're very hard-working"],
  ["I'm fine", "I'm fine"],
  ["She's very poor", "She's very poor"],
