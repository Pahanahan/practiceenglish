...
const audio01 = new Audio("audio01/fine.wav");
const audio02 = new Audio("audio01/smart.wav");
const audio03 = new Audio("audio01/difficult.wav");
const audio04 = new Audio("audio01/ok.wav");
const audio05 = new Audio("audio01/seventy.wav");
const audio06 = new Audio("audio01/single.wav");
const audio07 = new Audio("audio01/married.wav");
const audio08 = new Audio("audio01/possible.wav");
const audio09 = new Audio("audio01/rich.wav");
const audio10 = new Audio("audio01/ready.wav");
