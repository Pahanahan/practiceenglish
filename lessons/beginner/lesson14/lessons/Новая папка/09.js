...
const audio01 = new Audio("audio09/they_are_my_friends.wav");
const audio02 = new Audio("audio09/they_are_teachers.wav");
const audio03 = new Audio("audio09/she_is_sixty_years_old.wav");
const audio04 = new Audio("audio09/he_is_very_old.wav");
const audio05 = new Audio("audio09/he_is_a_teacher.wav");
const audio06 = new Audio("audio09/he_is_my_best_friend.wav");
const audio07 = new Audio("audio09/she_is_a_secretary.wav");
const audio08 = new Audio("audio09/you_are_my_best_friend.wav");
const audio09 = new Audio("audio09/she_is_very_young.wav");
const audio10 = new Audio("audio09/he_is_my_friend.wav");
