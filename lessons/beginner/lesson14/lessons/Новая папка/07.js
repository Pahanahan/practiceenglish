...
const audio01 = new Audio("audio07/she_is_at_school.wav");
const audio02 = new Audio("audio07/she_is_busy_now.wav");
const audio03 = new Audio("audio07/she_is_very_sad.wav");
const audio04 = new Audio("audio07/it_is_interesting.wav");
const audio05 = new Audio("audio07/it_is_very_good.wav");
