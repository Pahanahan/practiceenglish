...
const audio01 = new Audio("audio12/it_is_a_problem.wav");
const audio02 = new Audio("audio12/it_is_more_than_enough.wav");
const audio03 = new Audio("audio12/he_is_a_businessman.wav");
const audio04 = new Audio("audio12/it_is_love.wav");
const audio05 = new Audio("audio12/i_am_thirty.wav");
const audio06 = new Audio("audio12/i_am_in_my_room.wav");
const audio07 = new Audio("audio12/it_is_a_fact.wav");
const audio08 = new Audio("audio12/he_is_a_manager.wav");
const audio09 = new Audio("audio12/he_is_a_programmer.wav");
const audio10 = new Audio("audio12/she_is_a_teacher.wav");
