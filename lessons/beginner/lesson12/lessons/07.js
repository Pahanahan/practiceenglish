...
const audio01 = new Audio("audio07/what_do_you_prefer.wav");
const audio02 = new Audio("audio07/when_do_you_get_up.wav");
const audio03 = new Audio("audio07/what_does_she_tell_you.wav");
const audio04 = new Audio("audio07/how_do_you_download_these_documents.wav");
const audio05 = new Audio("audio07/how_does_it_help_you.wav");
...
const answersArray = [
  ...
  "How do you download these documents?",
