...
const audio01 = new Audio("audio10/how_regularly_do_you_do_sport.wav");
const audio02 = new Audio("audio10/what_time_do_you_leave_work.wav");
const audio03 = new Audio("audio10/what_time_do_you_usually_get_up.wav");
const audio04 = new Audio("audio10/when_do_you_want_to_visit_this_island.wav");
const audio05 = new Audio("audio10/what_food_does_he_prefer.wav");

const answersArray = [
  [
    "Как регулярно ты занимаешься спортом?",
    "Как регулярно занимаешься ты спортом?",
  ],
  ["Во сколько ты уходишь с работы?", "Во сколько уходишь ты с работы?"],
  ["В какое время ты обычно встаешь?", "В какое время обычно ты встаешь?"],
  [
    "Когда ты хочешь посетить этот остров?",
    "Когда посетить ты хочешь этот остров?",
  ],
  [
    "Какую еду он предпочитает?",
    "Какую он еду предпочитает?",
  ],
];
