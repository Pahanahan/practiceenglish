...
const audio01 = new Audio("audio09/what_do_you_read_in_your_free_time.wav");
const audio02 = new Audio("audio09/how_many_friends_do_you_have.wav");
const audio03 = new Audio("audio09/what_countries_do_you_want_to_visit.wav");
const audio04 = new Audio("audio09/what_places_do_you_want_to_visit.wav");
const audio05 = new Audio("audio09/how_much_do_you_pay_for_your_education.wav");
const audio06 = new Audio("audio09/how_often_do_you_talk_on_the_phone.wav");
const audio07 = new Audio("audio09/when_do_you_want_to_go_to_this_island.wav");
const audio08 = new Audio("audio09/what_time_do_you_go_to_work.wav");
const audio09 = new Audio("audio09/what_english_level_does_he_have.wav");
const audio10 = new Audio("audio09/what_time_do_you_usually_get_up.wav");
...
"When do you want to go to this island?",
"What time do you go to work?",
"What English level does he have?",
