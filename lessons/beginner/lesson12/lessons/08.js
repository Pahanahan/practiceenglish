...
const audio01 = new Audio("audio08/what_does_he_recommend.wav");
const audio02 = new Audio("audio08/why_do_you_learn_english.wav");
const audio03 = new Audio("audio08/why_do_you_feel_so_sad.wav");
const audio04 = new Audio("audio08/what_do_you_think_about_this_thing.wav");
const audio05 = new Audio("audio08/when_do_you_have_time_for_it.wav");
const audio06 = new Audio("audio08/why_does_she_feel_so_sad.wav");
const audio07 = new Audio("audio08/how_does_it_work.wav");
const audio08 = new Audio("audio08/why_does_he_like_it.wav");
const audio09 = new Audio("audio08/where_do_you_work.wav");
const audio10 = new Audio("audio08/how_often_do_you_speak_english.wav");
