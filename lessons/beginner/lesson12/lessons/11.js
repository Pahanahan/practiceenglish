...
const audio01 = new Audio("audio11/how_regularly_do_you_do_it.wav");
const audio02 = new Audio("audio11/what_do_you_want_to_change.wav");
const audio03 = new Audio("audio11/what_cities_does_he_want_to_visit.wav");
const audio04 = new Audio("audio11/what_does_she_know.wav");
const audio05 = new Audio("audio11/how_regularly_do_you_train.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
  ["Как регулярно ты это делаешь?", "Как регулярно это ты делаешь?"],
  ["Что ты хочешь поменять?", "Что ты хочешь поменять?"],
  ["Какие города он хочет посетить?", "Какие города хочет он посетить?"],
  ["Что она знает?", "Что она знает?"],
  ["Как регулярно ты тренируешься?", "Как регулярно ты тренируешься?"],
];
