...
const audio01 = new Audio("audio02/download.wav");
const audio02 = new Audio("audio02/all.wav");
const audio03 = new Audio("audio02/file.wav");
const audio04 = new Audio("audio02/level.wav");
const audio05 = new Audio("audio02/regular.wav");
const audio06 = new Audio("audio02/document.wav");
const audio07 = new Audio("audio02/island.wav");
