...
const audio01 = new Audio("audio05/how_do_you_download_it.wav");
const audio02 = new Audio("audio05/what_do_you_see_now.wav");
const audio03 = new Audio("audio05/why_do_you_do_it.wav");
const audio04 = new Audio("audio05/when_does_it_happen.wav");
const audio05 = new Audio("audio05/when_do_you_have_time_for_all_these_things.wav");
const audio06 = new Audio("audio05/what_does_he_like_more.wav");
const audio07 = new Audio("audio05/what_do_you_usually_tell_him.wav");
const audio08 = new Audio("audio05/how_do_you_feel.wav");
const audio09 = new Audio("audio05/where_does_she_study.wav");
const audio10 = new Audio("audio05/why_do_you_read_it.wav");
const audio11 = new Audio("audio05/when_does_it_usually_happen.wav");
const audio12 = new Audio("audio05/why_does_he_feel_so_unhappy.wav");
const audio13 = new Audio("audio05/how_often_do_you_travel.wav");
const audio14 = new Audio("audio05/how_much_does_it_cost.wav");
const audio15 = new Audio("audio05/why_do_you_like_it_so_much.wav");
