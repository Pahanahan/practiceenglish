...
const audio01 = new Audio("audio04/why_do_you_read_it.wav");
const audio02 = new Audio("audio04/when_does_it_happen.wav");
const audio03 = new Audio("audio04/when_do_you_get_up.wav");
const audio04 = new Audio("audio04/where_does_she_study.wav");
const audio05 = new Audio("audio04/what_do_you_prefer.wav");
const audio06 = new Audio("audio04/why_do_you_do_it.wav");
const audio07 = new Audio("audio04/how_do_you_feel.wav");
const audio08 = new Audio("audio04/how_much_does_it_cost.wav");
const audio09 = new Audio("audio04/how_often_do_you_speak_english.wav");
const audio10 = new Audio("audio04/what_time_do_you_come.wav");
