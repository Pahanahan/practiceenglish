...
const audio01 = new Audio("audio06/what_does_she_usually_say.wav");
const audio02 = new Audio("audio06/where_does_she_work.wav");
const audio03 = new Audio("audio06/how_do_you_download_these_files.wav");
const audio04 = new Audio("audio06/where_do_you_study.wav");
const audio05 = new Audio("audio06/where_do_they_play.wav");
const audio06 = new Audio("audio06/how_does_he_feel.wav");
const audio07 = new Audio("audio06/what_does_he_say.wav");
const audio08 = new Audio("audio06/what_do_you_see.wav");
const audio09 = new Audio("audio06/which_drink_do_you_prefer.wav");
const audio10 = new Audio("audio06/why_does_she_feel_unhappy.wav");

const answersArray = [
  ["Что она обычно говорит?", "Что обычно она говорит?"],
  ["Где она работает?", "Где она работает?"],
  ["Как ты скачиваешь эти файлы?", "Как скачиваешь ты эти файлы?"],
  ["Где ты учишься?", "Где ты учишься?"],
  ["Где они играют?", "Где они играют?"],
  ["Как он себя чувствует?", "Как он себя чувствует?"],
  ["Что он говорит?", "Что он говорит?"],
  ["Что ты видишь?", "Что ты видишь?"],
  ["Какой напиток ты предпочитаешь?", "Какой ты напиток предпочитаешь?"],
  ["Почему она себя чувствует несчастной?", "Почему она чувствует себя несчастной?"],
];
