...
const audio01 = new Audio("audio12/what_time_do_you_come_home.wav");
const audio02 = new Audio("audio12/how_much_money_do_you_have.wav");
const audio03 = new Audio("audio12/what_food_do_you_prefer.wav");
const audio04 = new Audio("audio12/how_much_do_you_pay.wav");
const audio05 = new Audio("audio12/what_level_does_he_have.wav");
const audio06 = new Audio("audio12/what_food_do_you_like.wav");
const audio07 = new Audio("audio12/what_time_do_you_come_home_from_work.wav");
const audio08 = new Audio("audio12/what_do_you_want_to_do_in_your_free_time.wav");
const audio09 = new Audio("audio12/what_english_level_do_you_want_to_have.wav");
const audio10 = new Audio("audio12/what_time_do_you_usually_wake_up.wav");
