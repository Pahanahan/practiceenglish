...
const audio01 = new Audio(
  "audio13/what_time_does_she_leave_home_when_does_he_leave_work.wav"
);
const audio02 = new Audio(
  "audio13/how_do_you_usually_spend_your_free_time_what_does_she_usually_do_in_her_free_time.wav"
);
const audio03 = new Audio(
  "audio13/what_english_level_does_he_have_what_english_level_does_she_want_to_have.wav"
);
const audio04 = new Audio(
  "audio13/how_often_do_you_get_up_so_early_how_often_does_she_do_sport.wav"
);
const audio05 = new Audio(
  "audio13/how_often_do_you_go_there_how_regularly_does_she_do_that_exercise.wav"
);
const audio06 = new Audio(
  "audio13/how_much_does_he_pay_for_this_thing_how_much_does_she_pay.wav"
);
const audio07 = new Audio(
  "audio13/how_much_money_do_you_pay_for_it_how_much_money_does_he_have.wav"
);
const audio08 = new Audio(
  "audio13/what_english_level_does_he_have_what_level_does_she_have.wav"
);
const audio09 = new Audio(
  "audio13/what_do_you_want_to_know_about_it_what_does_she_know_about_him.wav"
);
const audio10 = new Audio(
  "audio13/how_often_does_he_do_it_how_regularly_does_she_go_there.wav"
);

const answersArray = [
  [
    "What time does she leave home?. When does he leave work?",
    "When does he leave work?. What time does she leave home?",
  ],
  [
    "How do you usually spend your free time?. What does she usually do in her free time?",
    "What does she usually do in her free time?. How do you usually spend your free time?",
  ],
  [
    "What English level does he have?. What English level does she want to have?",
    "What English level does she want to have?. What English level does he have?",
  ],
  [
    "How often do you get up so early?. How often does she do sport?",
    "How often does she do sport?. How often do you get up so early?",
  ],
  [
    "How often do you go there?. How regularly does she do that exercise?",
    "How regularly does she do that exercise?. How often do you go there?",
  ],
  [
    "How much does he pay for this thing?. How much does she pay?",
    "How much does she pay?. How much does he pay for this thing?",
  ],
  [
    "How much money do you pay for it?. How much money does he have?",
    "How much money does he have?. How much money do you pay for it?",
  ],
  [
    "What English level does he have?. What level does she have?",
    "What level does she have?. What English level does he have?",
  ],
  [
    "What do you want to know about it?. What does she know about him?",
    "What does she know about him?. What do you want to know about it?",
  ],
  [
    "How often does he do it?. How regularly does she go there?",
    "How regularly does she go there?. How often does he do it?",
  ],
];
