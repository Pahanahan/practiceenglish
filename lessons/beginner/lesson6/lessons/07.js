...
const audio01 = new Audio("audio07/i_don't_want_it.wav");
const audio02 = new Audio("audio07/i_don't_go_there.wav");
const audio03 = new Audio("audio07/i_don't_have_free_time.wav");
const audio04 = new Audio("audio07/i_don't_hear_you.wav");
const audio05 = new Audio("audio07/you_don't_make_mistakes.wav");
