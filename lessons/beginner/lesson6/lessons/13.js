...
const audio01 = new Audio(
  "audio13/we_don't_want_to_buy_this_thing_we_don't_want_to_spend_our_life_on_this_thing.wav"
);
const audio02 = new Audio(
  "audio13/we_like_this_song_you_don't_like_this_book.wav"
);
const audio03 = new Audio(
  "audio13/he_wants_to_spend_his_time_on_it_you_dont't_want_to_spend_your_time_on_me.wav"
);
const audio04 = new Audio(
  "audio13/we_want_to_read_this_book_you_don't_want_to_talk_about_this_situation.wav"
);
const audio05 = new Audio(
  "audio13/we_don't_eat_this_food_you_don't_eat_it.wav"
);
const audio06 = new Audio(
  "audio13/they_don't_want_to_hear_it_we_want_to_talk_about_it_now.wav"
);
const audio07 = new Audio("audio13/i_don't_help_you_they_don't_help_us.wav");
const audio08 = new Audio(
  "audio13/i_know_that_you_want_it_i_see_that_they_want_it.wav"
);
const audio09 = new Audio(
  "audio13/i_don't_like_this_idea_we_don't_like_his_ideas.wav"
);
const audio10 = new Audio(
  "audio13/i_don't_pay_for_it_we_don't_want_to_pay_for_this_thing.wav"
);

const answersArray = [
  [
    "We don't want to buy this thing. We don't want to spend our life on this thing",
    "We don't want to spend our life on this thing. We don't want to buy this thing",
  ],
  [
    "We like this song. You don't like this book",
    "You don't like this book. We like this song",
  ],
  [
    "He wants to spend his time on it. You don't want to spend your time on me",
    "You don't want to spend your time on me. He wants to spend his time on it",
  ],
  [
    "We want to read this book. You don't want to talk about this situation",
    "You don't want to talk about this situation. We want to read this book",
  ],
  [
    "We don't eat this food. You don't eat it",
    "You don't eat it. We don't eat this food",
  ],
  [
    "They don't want to hear it. We want to talk about it now",
    "We want to talk about it now. They don't want to hear it",
  ],
  [
    "I don't help you. They don't help us",
    "They don't help us. I don't help you",
  ],
  [
    "I know that you want it. I see that they want it",
    "I see that they want it. I know that you want it",
  ],
  [
    "I don't like this idea. We don't like his ideas",
    "We don't like his ideas. I don't like this idea",
  ],
  [
    "I don't pay for it. We don't want to pay for this thing",
    "We don't want to pay for this thing. I don't pay for it",
  ],
];
