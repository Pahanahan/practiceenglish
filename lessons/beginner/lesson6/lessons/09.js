...
const audio01 = new Audio("audio09/i_don't_want_to_work_there.wav");
const audio02 = new Audio("audio09/we_talk_about_different_things.wav");
const audio03 = new Audio("audio09/i_don't_want_to_spend_my_money_on_it.wav");
const audio04 = new Audio("audio09/i_don't_like_their_idea.wav");
const audio05 = new Audio("audio09/they_don't_have_big_money.wav");
const audio06 = new Audio("audio09/i_don't_want_to_buy_it.wav");
const audio07 = new Audio("audio09/i_don't_want_to_talk_about_this_thing.wav");
const audio08 = new Audio("audio09/i_don't_want_to_live_in_that_country.wav");
const audio09 = new Audio("audio09/i_don't_eat_this_food.wav");
const audio10 = new Audio(
  "audio09/i_don't_want_to_spend_my_money_on_these_things.wav"
);
