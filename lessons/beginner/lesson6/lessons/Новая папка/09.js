...
const audio01 = new Audio("audio09/i_want_to_buy_a_computer.wav");
const audio02 = new Audio("audio09/i'd_like_to_read_english_books.wav");
const audio03 = new Audio("audio09/i_understand_her.wav");
const audio04 = new Audio("audio09/i_want_to_live_in_this_city.wav");
const audio05 = new Audio("audio09/i_see_his_father.wav");
const audio06 = new Audio("audio09/i_want_to_live_in_this_country.wav");
const audio07 = new Audio("audio09/i_want_to_buy_two_tickets.wav");
const audio08 = new Audio("audio09/she_wants_to_help_us.wav");
const audio09 = new Audio("audio09/he_wants_to_study_there.wav");
const audio10 = new Audio("audio09/he_wants_to_help_me.wav");

const answersArray = [
"I want to buy a computer",
"I'd like to read English books",
"I understand her",
