...
const audio01 = new Audio("audio08/i_want_to_be_a_programmer.wav");
const audio02 = new Audio("audio08/i_want_to_understand_it.wav");
const audio03 = new Audio("audio08/i_want_to_buy_this_thing.wav");
const audio04 = new Audio("audio08/i'd_like_to_speak_english_fluently.wav");
const audio05 = new Audio("audio08/we_want_to_buy_that_thing.wav");
const audio06 = new Audio("audio08/i_really_want_to_understand_it.wav");
const audio07 = new Audio("audio08/i'd_like_to_speak_english_correctly.wav");
const audio08 = new Audio("audio08/i_want_to_become_a_teacher.wav");
const audio09 = new Audio("audio08/she_wants_to_live_abroad.wav");
const audio10 = new Audio("audio08/i_want_to_speak_english_fluently.wav");
