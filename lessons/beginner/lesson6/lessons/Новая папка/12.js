...
const audio01 = new Audio("audio12/i_want_to_do_it_next_week.wav");
const audio02 = new Audio("audio12/i_want_to_read_that_book.wav");
const audio03 = new Audio("audio12/i'd_like_to_go_to_the_united_states.wav");
const audio04 = new Audio("audio12/i'd_like_to_visit_japan.wav");
const audio05 = new Audio("audio12/we_want_to_visit_italy_next_month.wav");
const audio06 = new Audio("audio12/i_see_their_house.wav");
const audio07 = new Audio("audio12/i_understand_them.wav");
const audio08 = new Audio(
  "audio12/i_want_to_visit_the_united_states_next_year.wav"
);
const audio09 = new Audio("audio12/i_want_to_learn_english_here.wav");
const audio10 = new Audio("audio12/i_want_to_buy_a_ticket.wav");
