...
const audio01 = new Audio("audio10/they_don't_have_time.wav");
const audio02 = new Audio(
  "audio10/they_don't_want_to_live_in_this_country.wav"
);
const audio03 = new Audio("audio10/they_don't_tell_me_these_things.wav");
const audio04 = new Audio("audio10/they_often_talk_about_politics.wav");
const audio05 = new Audio("audio10/i_see_that_you_don't_like_it.wav");

const answersArray = [
  ["У них нет времени", "У них времени нет"],
  ["Они не хотят жить в этой стране", "Они не хотят в этой стране жить"],
  ["Они не говорят мне эти вещи", "Они эти вещи мне не говорят"],
  ["Они часто говорят о политике", "Они часто о политике говорят"],
  ["Я вижу, что тебе не нравится это", "Я вижу, что это тебе не нравится"],
];
