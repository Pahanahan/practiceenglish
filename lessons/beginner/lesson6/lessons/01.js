...
const audio01 = new Audio("audio01/politics.wav");
const audio02 = new Audio("audio01/course.wav");
const audio03 = new Audio("audio01/situation.wav");
const audio04 = new Audio("audio01/those.wav");
const audio05 = new Audio("audio01/spend.wav");
const audio06 = new Audio("audio01/control.wav");
const audio07 = new Audio("audio01/talk.wav");
