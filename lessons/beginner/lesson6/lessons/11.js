...
const audio01 = new Audio("audio11/we_often_talk_about_it.wav");
const audio02 = new Audio("audio11/i_don't_want_to_be_a_businessman.wav");
const audio03 = new Audio("audio11/i_don't_like_this_music.wav");
const audio04 = new Audio("audio11/i_don't_understand_them.wav");
const audio05 = new Audio("audio11/they_don't_like_this_game.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
  ["Мы часто разговариваем об этом", "Мы часто об этом разговариваем"],
["Я не хочу быть бизнесменом", "Я не хочу бизнесменом быть"],
["Мне не нравится эта музыка", "Мне эта музыка не нравится"],
["Я не понимаю их", "Я их не понимаю"],
["Им не нравится эта игра", "Им эта игра не нравится"],
];
