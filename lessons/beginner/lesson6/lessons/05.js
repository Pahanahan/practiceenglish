...
const audio01 = new Audio("audio05/i_don't_know.wav");
const audio02 = new Audio("audio05/they_don't_control_it.wav");
const audio03 = new Audio("audio05/i_don't_like_this_idea.wav");
const audio04 = new Audio("audio05/they_don't_agree_with_it.wav");
const audio05 = new Audio("audio05/i_don't_do_those_exercises.wav");
const audio06 = new Audio("audio05/they_don't_agree.wav");
const audio07 = new Audio("audio05/they_play_tennis.wav");
const audio08 = new Audio("audio05/i_don't_do_it.wav");
const audio09 = new Audio("audio05/they_don't_understand_these_things.wav");
const audio10 = new Audio("audio05/i_don't_make_mistakes.wav");
const audio11 = new Audio("audio05/i_don't_like_this_game.wav");
const audio12 = new Audio("audio05/they_don't_pay_for_it.wav");
const audio13 = new Audio("audio05/we_don't_want_it.wav");
const audio14 = new Audio("audio05/i_don't_do_business.wav");
const audio15 = new Audio("audio05/i_don't_pay.wav");
