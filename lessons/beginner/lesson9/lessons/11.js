...
const audio01 = new Audio("audio11/do_they_want_to_buy_a_computer.wav");
const audio02 = new Audio("audio11/do_you_think_you_have_good_results.wav");
const audio03 = new Audio("audio11/do_you_often_write_in_english.wav");
const audio04 = new Audio("audio11/do_you_feel_progress.wav");
const audio05 = new Audio("audio11/do_you_want_to_learn_english_here.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
  ["Они хотят купить компьютер?", "Они хотят купить компьютер?"],
  ["Ты думаешь, у тебя хорошие результаты?", "Ты думаешь, у тебя хорошие результаты?"],
  ["Ты часто пишешь на английском?", "Ты часто пишешь на английском?"],
  ["Ты чувствуешь прогресс?", "Ты чувствуешь прогресс?"],
  ["Ты хочешь изучать английский здесь?", "Ты хочешь английский изучать здесь?"],
];
