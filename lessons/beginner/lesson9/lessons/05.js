...
const audio01 = new Audio("audio05/do_you_study.wav");
const audio02 = new Audio("audio05/do_you_train_very_intensively.wav");
const audio03 = new Audio("audio05/do_you_have_free_time_now.wav");
const audio04 = new Audio("audio05/do_you_often_go_to_that_place.wav");
const audio05 = new Audio("audio05/do_they_support_this_idea.wav");
const audio06 = new Audio("audio05/do_you_like_this_weather.wav");
const audio07 = new Audio("audio05/do_you_like_this_course.wav");
const audio08 = new Audio("audio05/do_you_hear_me.wav");
const audio09 = new Audio("audio05/do_you_understand_me.wav");
const audio10 = new Audio("audio05/do_you_feel_your_progress.wav");
const audio11 = new Audio("audio05/do_you_have_many_friends.wav");
const audio12 = new Audio("audio05/do_you_like_singing.wav");
const audio13 = new Audio("audio05/do_you_have_good_results.wav");
const audio14 = new Audio("audio05/do_they_support_it.wav");
const audio15 = new Audio("audio05/do_you_see_it.wav");

const answersArray = [
  "Do you study?",
  "Do you train very intensively?",
  "Do you have free time now?",
  "Do you often go to that place?",
  "Do they support this idea?",
...
let beginner09 = JSON.parse(localStorage.getItem("beginner09"));
