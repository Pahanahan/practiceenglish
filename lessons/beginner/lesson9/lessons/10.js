...
const audio01 = new Audio("audio10/do_you_often_call_her.wav");
const audio02 = new Audio("audio10/do_you_find_this_book_very_boring.wav");
const audio03 = new Audio("audio10/do_they_pay_for_this_service.wav");
const audio04 = new Audio("audio10/do_you_know_why_it_happens.wav");
const audio05 = new Audio("audio10/do_you_know_how_it_works.wav");

const answersArray = [
  ["Ты часто звонишь ей?", "Ты часто звонишь ей?"],
  [
    "Ты находишь эту книгу очень скучной?",
    "Ты эту книгу находишь очень скучной?",
  ],
  ["Они платят за эту услугу?", "Они платят за эту услугу?"],
  ["Ты знаешь, почему это происходит?", "Ты знаешь, почему это происходит?"],
  ["Ты знаешь, как это работает?", "Ты знаешь, как это работает?"],
];
