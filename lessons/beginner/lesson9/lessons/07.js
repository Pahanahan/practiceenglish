...
const audio01 = new Audio("audio07/do_you_have_any_plans.wav");
const audio02 = new Audio("audio07/do_you_want_it.wav");
const audio03 = new Audio("audio07/do_we_train_intensively.wav");
const audio04 = new Audio("audio07/do_you_often_go_there.wav");
const audio05 = new Audio("audio07/do_you_agree.wav");
