...
const audio01 = new Audio("audio01/singing.wav");
const audio02 = new Audio("audio01/weather.wav");
const audio03 = new Audio("audio01/cinema.wav");
const audio04 = new Audio("audio01/show.wav");
const audio05 = new Audio("audio01/write.wav");
const audio06 = new Audio("audio01/train.wav");
const audio07 = new Audio("audio01/support.wav");
const audio08 = new Audio("audio01/reading.wav");
const audio09 = new Audio("audio01/real.wav");
