...
const audio01 = new Audio("audio04/do_you_understand_me.wav");
const audio02 = new Audio("audio04/do_they_buy_it_online.wav");
const audio03 = new Audio("audio04/do_you_know_how_it_works.wav");
const audio04 = new Audio("audio04/do_you_know_why_it_happens.wav");
const audio05 = new Audio("audio04/do_you_like_reading.wav");
const audio06 = new Audio("audio04/does_she_like_studying.wav");
