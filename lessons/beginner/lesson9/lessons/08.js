...
const audio01 = new Audio("audio08/do_you_like_reading.wav");
const audio02 = new Audio("audio08/do_you_read_in_english.wav");
const audio03 = new Audio("audio08/do_you_understand.wav");
const audio04 = new Audio("audio08/do_they_like_dancing.wav");
const audio05 = new Audio("audio08/do_you_have_any_ideas.wav");
const audio06 = new Audio("audio08/do_you_need_my_help.wav");
const audio07 = new Audio("audio08/do_you_speak_english.wav");
const audio08 = new Audio("audio08/do_you_feel_better.wav");
const audio09 = new Audio("audio08/do_i_speak_english_correctly.wav");
const audio10 = new Audio("audio08/do_you_like_this_idea.wav");
