...
const audio01 = new Audio("audio02/many.wav");
const audio02 = new Audio("audio02/park.wav");
const audio03 = new Audio("audio02/dancing.wav");
const audio04 = new Audio("audio02/chinese.wav");
const audio05 = new Audio("audio02/boring.wav");
const audio06 = new Audio("audio02/find.wav");
const audio07 = new Audio("audio02/or.wav");
const audio08 = new Audio("audio02/intensively.wav");
const audio09 = new Audio("audio02/movie.wav");
