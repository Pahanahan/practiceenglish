...
const audio01 = new Audio("audio05/i_don't_make_any_mistakes.wav");
const audio02 = new Audio("audio05/he_doesn't_think_so.wav");
const audio03 = new Audio("audio05/he_has_time.wav");
const audio04 = new Audio("audio05/i_want_to_visit_other_countries_and_cities.wav");
const audio05 = new Audio("audio05/she_wants_to_study_in_another_place.wav");
const audio06 = new Audio("audio05/he_doesn't_need_it.wav");
const audio07 = new Audio("audio05/she_feels_very_bad.wav");
const audio08 = new Audio("audio05/she_doesn't_have_free_time.wav");
const audio09 = new Audio("audio05/i_don't_have_any_questions_now.wav");
const audio10 = new Audio("audio05/he_doesn't_like_this_hotel.wav");
const audio11 = new Audio("audio05/he_has_money.wav");
const audio12 = new Audio("audio05/she_wants_to_work.wav");
const audio13 = new Audio("audio05/we_have_some_questions.wav");
const audio14 = new Audio("audio05/i_want_to_work_in_another_place.wav");
const audio15 = new Audio("audio05/i_need_more_time.wav");

const answersArray = [
  "I don't make any mistakes",
  "He doesn't think so",
  "He has time",
  "I want to visit other countries and cities",
  "She wants to study in another place",
  "He doesn't need it",
  "She feels very bad",
  "She doesn't have free time",
  "I don't have any questions now",
  "He doesn't like this hotel",
  "He has money",
  "She wants to work",
