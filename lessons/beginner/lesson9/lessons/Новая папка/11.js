...
const audio01 = new Audio("audio11/i_prefer_this_food.wav");
const audio02 = new Audio("audio11/he_doesn't_feel_happy.wav");
const audio03 = new Audio("audio11/i_want_to_read_those_books.wav");
const audio04 = new Audio("audio11/i_don't_want_to_play_this_game.wav");
const audio05 = new Audio("audio11/i_don't_want_to_make_these_mistakes_again_and_again.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
  ["Я предпочитаю эту еду", "Я предпочитаю эту еду"],
  ["Он не чувствует себя счастливым", "Он себя счастливым не чувствует"],
  ["Я хочу прочесть те книги", "Я хочу прочесть те книги"],
  ["Я не хочу играть в эту игру", "Я не хочу в эту игру играть"],
  ["Я не хочу делать эти ошибки снова и снова", "Я не хочу снова и снова делать эти ошибки"],
];
