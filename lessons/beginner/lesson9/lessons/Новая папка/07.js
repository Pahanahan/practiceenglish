...
const audio01 = new Audio("audio07/he_teaches_another_subject.wav");
const audio02 = new Audio("audio07/he_needs_more_practice.wav");
const audio03 = new Audio("audio07/i_need_this_thing.wav");
const audio04 = new Audio("audio07/i_need_it.wav");
const audio05 = new Audio("audio07/i_don't_want_to_live_in_this_place.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
  "He teaches another subject",
