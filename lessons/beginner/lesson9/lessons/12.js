...
const audio01 = new Audio("audio12/do_they_show_very_good_results.wav");
const audio02 = new Audio("audio12/do_you_really_like_this_game.wav");
const audio03 = new Audio("audio12/do_you_love_her.wav");
const audio04 = new Audio("audio12/do_you_often_travel.wav");
const audio05 = new Audio("audio12/do_you_often_read_in_english.wav");
const audio06 = new Audio("audio12/do_you_often_go_to_the_park.wav");
const audio07 = new Audio("audio12/do_you_feel_real_progress.wav");
const audio08 = new Audio("audio12/do_you_really_know_chinese.wav");
const audio09 = new Audio("audio12/do_you_usually_buy_it_online.wav");
const audio10 = new Audio("audio12/do_you_want_to_go_to_the_united_states.wav");
