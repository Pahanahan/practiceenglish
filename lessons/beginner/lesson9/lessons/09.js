...
const audio01 = new Audio("audio09/do_you_love_him.wav");
const audio02 = new Audio("audio09/do_they_buy_it_online.wav");
const audio03 = new Audio("audio09/do_you_find_this_idea_very_interesting.wav");
const audio04 = new Audio("audio09/do_you_pay_for_it.wav");
const audio05 = new Audio("audio09/do_you_often_do_it.wav");
const audio06 = new Audio("audio09/do_they_often_go_to_the_park.wav");
const audio07 = new Audio("audio09/do_you_go_to_the_cinema.wav");
const audio08 = new Audio("audio09/do_you_understand_why_they_do_it.wav");
const audio09 = new Audio("audio09/do_you_often_think_about_it.wav");
const audio10 = new Audio("audio09/do_you_work_or_study.wav");

const answersArray = [
"Do you love him?",
"Do they buy it online?",
"Do you find this idea very interesting?",
"Do you pay for it?",
"Do you often do it?",
"Do they often go to the park?",
