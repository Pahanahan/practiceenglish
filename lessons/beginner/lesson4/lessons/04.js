...
const audio01 = new Audio("audio04/we_see_two_men.wav");
const audio02 = new Audio("audio04/i_see_a_man_and_two_women.wav");
const audio03 = new Audio("audio04/she_has_two_children.wav");
const audio04 = new Audio("audio04/he_has_a_question.wav");
const audio05 = new Audio("audio04/she_has_two_daughters_and_a_son.wav");
const audio06 = new Audio("audio04/i_see_you_have_a_question.wav");
const audio07 = new Audio("audio04/i_see_that_you_have_little_free_time.wav");
