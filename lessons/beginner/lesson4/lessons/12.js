...
const audio01 = new Audio("audio12/i_love_sport_so_much.wav");
const audio02 = new Audio("audio12/he_reads_books_in_english.wav");
const audio03 = new Audio("audio12/i_see_a_hospital.wav");
const audio04 = new Audio("audio12/i_see_her_boyfriend.wav");
const audio05 = new Audio("audio12/she_has_a_boyfriend.wav");
const audio06 = new Audio("audio12/she_likes_that_place_more.wav");
const audio07 = new Audio("audio12/i_have_this_money.wav");
const audio08 = new Audio("audio12/i_like_ice_cream.wav");
const audio09 = new Audio("audio12/we_have_an_idea.wav");
const audio10 = new Audio("audio12/i_learn_foreign_languages.wav");
