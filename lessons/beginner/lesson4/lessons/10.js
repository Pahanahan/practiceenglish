...
const audio01 = new Audio("audio10/i_see_you_have_a_question.wav");
const audio02 = new Audio("audio10/he_has_an_idea.wav");
const audio03 = new Audio("audio10/she_knows_two_foreign_languages.wav");
const audio04 = new Audio("audio10/she_reads_english_books.wav");
const audio05 = new Audio("audio10/i_like_swimming.wav");

const answersArray = [
  ["Я вижу, у тебя есть вопрос", "Я вижу, у тебя вопрос есть"],
  ["У него есть идея", "У него есть идея"],
  ["Она знает два иностранных языка", "Она знает два иностранных языка"],
  ["Она читает английские книги", "Она английские книги читает"],
  ["Мне нравится плавать", "Мне плавать нравится"],
];
