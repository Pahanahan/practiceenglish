...
const audio01 = new Audio("audio07/he_has_an_apartment.wav");
const audio02 = new Audio("audio07/they_have_two_sons.wav");
const audio03 = new Audio("audio07/i_see_four_people.wav");
const audio04 = new Audio("audio07/they_have_a_child.wav");
const audio05 = new Audio("audio07/he_has_a_daughter.wav");
