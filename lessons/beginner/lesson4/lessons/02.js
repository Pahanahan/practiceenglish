...
const audio01 = new Audio("audio02/swimming.wav");
const audio02 = new Audio("audio02/children.wav");
const audio03 = new Audio("audio02/seafood.wav");
const audio04 = new Audio("audio02/child.wav");
const audio05 = new Audio("audio02/apartment.wav");
const audio06 = new Audio("audio02/airport.wav");
const audio07 = new Audio("audio02/daughter.wav");
