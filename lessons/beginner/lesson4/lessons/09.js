...
const audio01 = new Audio("audio09/he_likes_that_hotel_more.wav");
const audio02 = new Audio("audio09/he_likes_meat_more.wav");
const audio03 = new Audio("audio09/she_loves_sport.wav");
const audio04 = new Audio("audio09/he_knows_english_better.wav");
const audio05 = new Audio("audio09/i_have_an_idea.wav");
const audio06 = new Audio("audio09/she_likes_swimming.wav");
const audio07 = new Audio("audio09/it_often_happens.wav");
const audio08 = new Audio("audio09/he_has_this_money.wav");
const audio09 = new Audio("audio09/he_works_in_a_hospital.wav");
const audio10 = new Audio("audio09/we_see_a_hospital.wav");

const answersArray = [
  "He likes that hotel more",
  "He likes meat more",
'She loves sport',
'He knows English better',
'I have an idea',
'She likes swimming',
'It often happens',
'He has this money',
