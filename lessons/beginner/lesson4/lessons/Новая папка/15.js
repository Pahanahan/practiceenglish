...
const audio01 = new Audio("audio15/i_see_a_book.wav");
const audio02 = new Audio("audio15/i_see_a_taxi.wav");
const audio03 = new Audio("audio15/i_like_juice.wav");
const audio04 = new Audio("audio15/they_have_free_time.wav");
const audio05 = new Audio("audio15/i_often_eat_fish.wav");
const audio06 = new Audio("audio15/they_often_drink_milk.wav");
const audio07 = new Audio("audio15/i_have_a_result.wav");
const audio08 = new Audio("audio15/i_want_juice.wav");
const audio09 = new Audio("audio15/i_love_music.wav");
const audio10 = new Audio("audio15/they_drink_milk.wav");
