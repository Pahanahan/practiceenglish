...
const audio01 = new Audio("audio08/i_see_two_people.wav");
const audio02 = new Audio("audio08/i_see_a_boy.wav");
const audio03 = new Audio("audio08/i_know_this_person.wav");
const audio04 = new Audio("audio08/i_have_some_ideas.wav");
const audio05 = new Audio("audio08/i_have_an_apple.wav");
const audio06 = new Audio("audio08/we_see_a_teacher.wav");
const audio07 = new Audio("audio08/i_see_a_house.wav");
const audio08 = new Audio("audio08/i_have_little_free_time.wav");
const audio09 = new Audio("audio08/i_have_a_car.wav");
const audio10 = new Audio("audio08/i_have_a_sister.wav");
