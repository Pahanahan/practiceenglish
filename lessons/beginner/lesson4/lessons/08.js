...
const audio01 = new Audio("audio08/he_has_motivation.wav");
const audio02 = new Audio("audio08/she_has_a_problem.wav");
const audio03 = new Audio("audio08/he_sees_an_airport.wav");
const audio04 = new Audio("audio08/they_eat_meat_and_fish.wav");
const audio05 = new Audio("audio08/i_see_an_airport.wav");
const audio06 = new Audio("audio08/i_like_seafood.wav");
const audio07 = new Audio("audio08/he_eats_meat.wav");
const audio08 = new Audio("audio08/they_have_a_daughter.wav");
const audio09 = new Audio("audio08/he_knows_english_and_spanish.wav");
const audio10 = new Audio("audio08/we_see_a_woman_and_three_men.wav");
