...
const audio01 = new Audio("audio06/i_have_an_apartment.wav");
const audio02 = new Audio("audio06/she_sees_a_taxi.wav");
const audio03 = new Audio("audio06/i_like_cakes.wav");
const audio04 = new Audio("audio06/i_like_chocolate.wav");
const audio05 = new Audio("audio06/we_like_seafood.wav");
const audio06 = new Audio("audio06/she_eats_fish.wav");
const audio07 = new Audio("audio06/we_see_an_airport.wav");
const audio08 = new Audio("audio06/she_has_some_questions.wav");
const audio09 = new Audio("audio06/she_has_a_son.wav");
const audio10 = new Audio("audio06/she_has_little_free_time.wav");

const answersArray = [
  ["У меня есть квартира", "У меня квартира есть"],
  ["Она видит такси", "Она такси видит"],
  ["Мне нравятся торты", "Мне торты нравятся"],
  ["Мне нравится шоколад", "Мне шоколад нравится"],
  ["Нам нравятся морепродукты", "Нам нравятся морепродукты"],
  ["Она ест рыбу", "Она рыбу ест"],
  ["Мы видим аэропорт", "Мы видим аэропорт"],
  ["У нее есть некоторые вопросы", "У нее есть некоторые вопросы"],
  ["У нее есть сын", "У нее сын есть"],
  ["У нее мало свободного времени", "У нее свободного времени мало"],
];
