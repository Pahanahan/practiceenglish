...
const audio01 = new Audio("audio11/i_have_a_girlfriend.wav");
const audio02 = new Audio("audio11/he_likes_my_idea.wav");
const audio03 = new Audio("audio11/he_has_a_girlfriend.wav");
const audio04 = new Audio("audio11/i_like_this_hotel.wav");
const audio05 = new Audio("audio11/he_likes_pizza.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
["У меня есть девушка", "У меня девушка есть"],
["Ему нравится моя идея", "Ему моя идея нравится"],
["У него есть девушка", "У него девушка есть"],
["Мне нравится этот отель", "Мне этот отель нравится"],
["Ему нравится пицца", "Ему пицца нравится"]
];
