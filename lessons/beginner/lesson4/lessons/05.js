...
const audio01 = new Audio("audio05/she_has_two_daughters_and_a_son.wav");
const audio02 = new Audio("audio05/i_see_a_man_and_two_women.wav");
const audio03 = new Audio("audio05/he_has_a_job.wav");
const audio04 = new Audio("audio05/i_see_three_women.wav");
const audio05 = new Audio("audio05/she_has_two_children.wav");
const audio06 = new Audio("audio05/she_speaks_english_and_german.wav");
const audio07 = new Audio("audio05/we_see_two_men.wav");
const audio08 = new Audio("audio05/i_like_english.wav");
const audio09 = new Audio("audio05/i_really_like_english.wav");
const audio10 = new Audio("audio05/she_has_children.wav");
const audio11 = new Audio("audio05/he_has_little_free_time.wav");
const audio12 = new Audio("audio05/he_sees_one_woman.wav");
const audio13 = new Audio("audio05/he_has_a_question.wav");
const audio14 = new Audio("audio05/he_has_a_child.wav");
const audio15 = new Audio("audio05/i_see_a_mistake.wav");
...
let beginner04 = JSON.parse(localStorage.getItem("beginner04"));
...
const saveToLocalStorage = function () {
  localStorage.setItem("beginner04", JSON.stringify(beginner04));
};
