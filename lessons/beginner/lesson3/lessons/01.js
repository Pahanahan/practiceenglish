...
const audio01 = new Audio("audio01/car.wav");
const audio02 = new Audio("audio01/free.wav");
const audio03 = new Audio("audio01/some.wav");
const audio04 = new Audio("audio01/woman.wav");
const audio05 = new Audio("audio01/your.wav");
const audio06 = new Audio("audio01/bus.wav");
const audio07 = new Audio("audio01/girl.wav");
