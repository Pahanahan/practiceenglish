...
const audio01 = new Audio("audio13/i_drink_tea.wav");
const audio02 = new Audio("audio13/i_eat_fish.wav");
const audio03 = new Audio("audio13/i_do_different_exercises.wav");
const audio04 = new Audio("audio13/i_like_these_exercises.wav");
const audio05 = new Audio("audio13/we_see_a_taxi.wav");

const answersArray = [
  ["Я пью чай", "Я пью чай"],
  ["Я ем рыбу", "Я ем рыбу"],
  ["Я делаю разные упражнения", "Я делаю разные упражнения"],
  ["Мне нравятся эти упражнения", "Мне эти упражнения нравятся"],
  ["Мы видим такси", "Мы видим такси"],
];
