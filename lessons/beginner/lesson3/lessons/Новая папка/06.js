...
const audio01 = new Audio("audio06/it_costs_much_more.wav");
const audio02 = new Audio("audio06/i_live_near.wav");
const audio03 = new Audio("audio06/she_makes_mistakes.wav");
const audio04 = new Audio("audio06/she_often_buys_these_tickets.wav");
const audio05 = new Audio("audio06/she_lives_in_that_place.wav");
const audio06 = new Audio("audio06/he_understands.wav");
const audio07 = new Audio("audio06/he_lives_here.wav");
const audio08 = new Audio("audio06/it_costs_twenty_euros.wav");
const audio09 = new Audio("audio06/he_lives_in_that_city.wav");
const audio10 = new Audio("audio06/she_agrees_with_it.wav");

const answersArray = [
  ["Это стоит намного больше", "Это намного больше стоит"],
  ["Я живу рядом", "Я рядом живу"],
  ["Она делает ошибки", "Она делает ошибки"],
  ["Она часто покупает эти билеты", "Она покупает эти билеты часто"],
  ["Она живет в том месте", "Она в том месте живет"],
  ["Он понимает", "Он понимает"],
  ["Он живет здесь", "Он здесь живет"],
  ["Это стоит двадцать евро", "Это стоит двадцать евро"],
  ["Он живет в том городе", "Он в том городе живет"],
  ["Она согласна с этим", "Она с этим согласна"],
];
