...
const audio01 = new Audio("audio05/i_see_a_bus.wav");
const audio02 = new Audio("audio05/i_have_some_questions.wav");
const audio03 = new Audio("audio05/i_have_a_problem.wav");
const audio04 = new Audio("audio05/i_have_time.wav");
const audio05 = new Audio("audio05/i_have_some_results.wav");
const audio06 = new Audio("audio05/i_understand_your_question.wav");
const audio07 = new Audio("audio05/i_see_a_hotel.wav");
const audio08 = new Audio("audio05/i_have_a_brother.wav");
const audio09 = new Audio("audio05/i_know_this_man.wav");
const audio10 = new Audio("audio05/i_see_a_university.wav");
const audio11 = new Audio("audio05/i_see_a_teacher.wav");
const audio12 = new Audio("audio05/i_want_an_apple.wav");
const audio13 = new Audio("audio05/i_see_a_woman.wav");
const audio14 = new Audio("audio05/i_see_a_girl.wav");
const audio15 = new Audio("audio05/i_have_an_orange.wav");
