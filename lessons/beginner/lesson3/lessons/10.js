...
const audio01 = new Audio("audio10/taxi.wav");
const audio02 = new Audio("audio10/juice.wav");
const audio03 = new Audio("audio10/sport.wav");
const audio04 = new Audio("audio10/student.wav");
const audio05 = new Audio("audio10/drink.wav");
const audio06 = new Audio("audio10/bank.wav");
const audio07 = new Audio("audio10/water.wav");
