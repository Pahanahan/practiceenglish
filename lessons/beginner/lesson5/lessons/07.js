...
const audio01 = new Audio("audio07/i_want_to_do_it_now.wav");
const audio02 = new Audio("audio07/i_want_to_be_a_businessman.wav");
const audio03 = new Audio("audio07/i_want_to_buy_it.wav");
const audio04 = new Audio("audio07/i_want_to_visit_this_city.wav");
const audio05 = new Audio("audio07/she_wants_to_be_a_teacher.wav");
