...
const audio01 = new Audio("audio11/i_want_to_study_here.wav");
const audio02 = new Audio("audio11/i_see_his_car.wav");
const audio03 = new Audio("audio11/i_see_them_now.wav");
const audio04 = new Audio("audio11/i_want_to_read_books_in_english.wav");
const audio05 = new Audio("audio11/i_want_to_visit_germany.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
  ["Я хочу учиться здесь", "Я хочу здесь учиться"],
  ["Я вижу его машину", "Я машину его вижу"],
  ["Я вижу их сейчас", "Я сейчас их вижу"],
  ["Я хочу читать книги на английском", "Я хочу читать на английском книги"],
  ["Я хочу посетить Германию", "Я хочу Германию посетить"],
];
