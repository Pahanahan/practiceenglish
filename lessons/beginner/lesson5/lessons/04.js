...
const audio01 = new Audio("audio04/i_want_to_see_it.wav");
const audio02 = new Audio("audio04/i'd_like_to_go_there_now.wav");
const audio03 = new Audio("audio04/i'd_like_to_speak_english_better.wav");
const audio04 = new Audio("audio04/i_want_to_see_her.wav");
const audio05 = new Audio("audio04/i_want_to_see_them.wav");
const audio06 = new Audio("audio04/i_want_to_see_him.wav");
const audio07 = new Audio("audio04/he_wants_to_help_me.wav");
const audio08 = new Audio("audio04/she_wants_to_help_us.wav");
const audio09 = new Audio("audio04/i_want_to_do_it_this_week.wav");
const audio10 = new Audio("audio04/i_want_to_go_to_china_next_year.wav");
