...
const audio01 = new Audio("audio06/i_want_to_be_a_teacher.wav");
const audio02 = new Audio("audio06/i_want_to_call_him.wav");
const audio03 = new Audio("audio06/i_want_to_travel.wav");
const audio04 = new Audio("audio06/i_want_to_visit_new_countries_and_cities.wav");
const audio05 = new Audio("audio06/i'd_like_to_speak_english_better.wav");
const audio06 = new Audio("audio06/i_want_to_be_a_designer.wav");
const audio07 = new Audio("audio06/i_want_it.wav");
const audio08 = new Audio("audio06/i_want_to_work.wav");
const audio09 = new Audio("audio06/i_want_to_call_her_now.wav");
const audio10 = new Audio("audio06/i_want_to_be_a_manager.wav");

const answersArray = [
["Я хочу быть учителем", "Я хочу быть учителем"],
["Я хочу позвонить ему", "Я хочу ему позвонить"],
["Я хочу путешествовать", "Я хочу путешествовать"],
["Я хочу посетить новые страны и города", "Я хочу посетить новые города и страны"],
["Я хотел бы говорить по-английски лучше", "Я хотел бы говорить по-английски лучше"],
["Я хочу быть дизайнером", "Я хочу быть дизайнером"],
["Я хочу это", "Я это хочу"],
["Я хочу работать", "Я работать хочу"],
["Я хочу позвонить ей сейчас", "Я хочу ей сейчас позвонить"],
["Я хочу быть менеджером", "Я хочу быть менеджером"],
];
