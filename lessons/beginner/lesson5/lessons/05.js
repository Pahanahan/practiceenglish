...
const audio04 = new Audio("audio05/i_want_to_be_a_doctor.wav");
const audio05 = new Audio("audio05/he_wants_to_be_a_teacher.wav");
const audio06 = new Audio("audio05/i_want_to_speak_english_correctly.wav");
const audio07 = new Audio(
  "audio05/i'd_like_to_speak_english_fluently_and_correctly.wav"
);
const audio08 = new Audio(
  "audio05/i_want_to_speak_english_without_mistakes.wav"
);
const audio09 = new Audio("audio05/i_want_to_see_them.wav");
const audio10 = new Audio("audio05/i_want_to_become_a_programmer.wav");
const audio11 = new Audio(
  "audio05/i_want_to_speak_english_fluently_and_correctly.wav"
);
const audio12 = new Audio("audio05/i_want_to_see_him.wav");
const audio13 = new Audio("audio05/i_want_to_see_her.wav");
const audio14 = new Audio("audio05/i_want_to_visit_this_country.wav");
const audio15 = new Audio("audio05/i_want_to_be_happy.wav");
...
const answersArray = [
  ...
  "I'd like to speak English fluently and correctly",
...
const saveToLocalStorage = function () {
  localStorage.setItem("beginner05", JSON.stringify(beginner05));
};
