...
const audio01 = new Audio("audio01/doctor.wav");
const audio02 = new Audio("audio01/the_united_states.wav");
const audio03 = new Audio("audio01/fluently.wav");
const audio04 = new Audio("audio01/them.wav");
const audio05 = new Audio("audio01/businessman.wav");
const audio06 = new Audio("audio01/happy.wav");
const audio07 = new Audio("audio01/england.wav");
const audio08 = new Audio("audio01/italy.wav");
