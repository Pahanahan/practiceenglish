...
const audio01 = new Audio("audio10/i'd_like_to_speak_english_without_mistakes.wav");
const audio02 = new Audio("audio10/i_see_her_mother.wav");
const audio03 = new Audio("audio10/i_like_their_idea.wav");
const audio04 = new Audio("audio10/i'd_like_to_visit_new_countries_and_cities.wav");
const audio05 = new Audio("audio10/i'd_like_to_go_to_england.wav");

const answersArray = [
 ["Я хотел бы говорить по-английски без ошибок", "Я хотел бы говорить по-английски без ошибок"],
 ["Я вижу ее маму", "Я ее маму вижу"],
["Мне нравится их идея", "Мне их идея нравится"],
["Я хотел бы посетить новые страны и города", "Я хотел бы посетить новые города и страны"],
["Я хотел бы поехать в Англию", "Я хотел бы в Англию поехать"]
];
