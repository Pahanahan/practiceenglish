...
const audio01 = new Audio("audio02/food.wav");
const audio02 = new Audio("audio02/pay.wav");
const audio03 = new Audio("audio02/education.wav");
const audio04 = new Audio("audio02/business.wav");
const audio05 = new Audio("audio02/big.wav");
const audio06 = new Audio("audio02/future.wav");
const audio07 = new Audio("audio02/tennis.wav");
