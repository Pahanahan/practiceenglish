...
const audio01 = new Audio(
  "audio12/i_don't_want_to_pay_so_much_money_for_it.wav"
);
const audio02 = new Audio("audio12/i_don't_want_to_be_a_manager.wav");
const audio03 = new Audio("audio12/i_don't_want_to_talk_about_politics.wav");
const audio04 = new Audio("audio12/i_don't_understand_him.wav");
const audio05 = new Audio("audio12/i_don't_drink_coffee.wav");
const audio06 = new Audio("audio12/they_don't_have_money.wav");
const audio07 = new Audio("audio12/they_don't_say_it.wav");
const audio08 = new Audio(
  "audio12/i_don't_want_to_spend_so_much_money_on_it.wav"
);
const audio09 = new Audio("audio12/i_don't_want_to_pay.wav");
const audio10 = new Audio("audio12/we_don't_have_free_time.wav");
