...
const audio01 = new Audio("audio04/they_don't_agree.wav");
const audio02 = new Audio("audio04/i_don't_make_mistakes.wav");
const audio03 = new Audio("audio04/i_don't_do_business.wav");
const audio04 = new Audio("audio04/i_pay_for_it.wav");
const audio05 = new Audio("audio04/they_don't_play_football.wav");
const audio06 = new Audio("audio04/i_don't_want_to_spend_my_money_on_it.wav");
