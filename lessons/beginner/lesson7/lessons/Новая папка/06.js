...
const audio01 = new Audio("audio06/i_don't_understand.wav");
const audio02 = new Audio("audio06/they_don't_make_mistakes.wav");
const audio03 = new Audio("audio06/we_don't_pay_for_our_education.wav");
const audio04 = new Audio("audio06/i_don't_have_much_time.wav");
const audio05 = new Audio("audio06/i_don't_think_about_it.wav");
const audio06 = new Audio("audio06/i_don't_have_time.wav");
const audio07 = new Audio("audio06/they_don't_play_football.wav");
const audio08 = new Audio("audio06/i_pay_for_it.wav");
const audio09 = new Audio("audio06/i_pay_for_my_education.wav");
const audio10 = new Audio("audio06/they_don't_think_about_their_future.wav");

const answersArray = [
["Я не понимаю", "Я не понимаю"],
["Они не делают ошибок", "Они ошибок не делают"],
["Мы не платим за наше образование", "Мы за наше образование не платим"],
["У меня нет много времени", "У меня нет много времени"],
["Я не думаю об этом", "Я об этом не думаю"],
["У меня нет времени", "У меня времени нет"],
["Они не играют в футбол", "Они в футбол не играют"],
["Я плачу за это", "Я за это плачу"],
["Я плачу за свое образование", "Я за свое образование плачу"],
["Они не думают о своем будущем", "Они о своем будущем не думают"]
];
