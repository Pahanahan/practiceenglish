...
const audio01 = new Audio("audio07/i_don't_use_this_service.wav");
const audio02 = new Audio("audio07/it_doesn't_work.wav");
const audio03 = new Audio("audio07/she_doesn't_like_it.wav");
const audio04 = new Audio("audio07/i_don't_think_so.wav");
const audio05 = new Audio("audio07/it_doesn't_motivate_him.wav");
