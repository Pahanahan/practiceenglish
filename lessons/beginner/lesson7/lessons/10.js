...
const audio01 = new Audio("audio10/she_doesn't_go_to_school.wav");
const audio02 = new Audio(
  "audio10/she_feels_better.wav"
);
const audio03 = new Audio("audio10/i_understand_how_it_works.wav");
const audio04 = new Audio("audio10/i_think_that_it_doesn't_work.wav");
const audio05 = new Audio("audio10/he_teaches_maths.wav");

const answersArray = [
  ["Она не ходит в школу", "Она в школу не ходит"],
  ["Она чувствует себя лучше", "Она себя лучше чувствует"],
  ["Я понимаю, как это работает", "Я понимаю, как это работает"],
  ["Я думаю, что это не работает", "Я думаю, что это не работает"],
  ["Он преподает математику", "Он преподает математику"],
];
