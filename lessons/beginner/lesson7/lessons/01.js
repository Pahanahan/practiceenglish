...
const audio01 = new Audio("audio01/internet.wav");
const audio02 = new Audio("audio01/test.wav");
const audio03 = new Audio("audio01/teach.wav");
const audio04 = new Audio("audio01/sell.wav");
const audio05 = new Audio("audio01/exam.wav");
const audio06 = new Audio("audio01/worry.wav");
const audio07 = new Audio("audio01/motivate.wav");
