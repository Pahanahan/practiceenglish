...
const audio01 = new Audio("audio04/it_doesn't_interest_them.wav");
const audio02 = new Audio("audio04/he_doesn't_like_it.wav");
const audio03 = new Audio("audio04/he_doesn't_have_any_questions.wav");
const audio04 = new Audio("audio04/i_don't_have_any_plans.wav");
