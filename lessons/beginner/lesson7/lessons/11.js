...
const audio01 = new Audio("audio11/i_like_this_subject.wav");
const audio02 = new Audio("audio11/she_doesn't_have_a_cat.wav");
const audio03 = new Audio("audio11/he_doesn't_worry_about_his_exams.wav");
const audio04 = new Audio("audio11/i_don't_want_to_watch_tv.wav");
const audio05 = new Audio("audio11/i_don't_want_to_worry_about_it.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
  ["Мне нравится этот предмет", "Мне этот предмет нравится"],
  ["У нее нет кошки", "У нее кошки нет"],
  ["Он не беспокоится о своих экзаменах", "Он не беспокоится о своих экзаменах"],
  ["Я не хочу смотреть телевизор", "Я не хочу телевизор смотреть"],
  ["Я не хочу беспокоится об этом", "Я об этом не хочу беспокоится"],
];
