...
const audio01 = new Audio("audio06/i_don't_have_any_plans.wav");
const audio02 = new Audio("audio06/she_doesn't_eat_this_food.wav");
const audio03 = new Audio("audio06/he_doesn't_have_any_questions.wav");
const audio04 = new Audio("audio06/she_doesn't_like_this_place.wav");
const audio05 = new Audio("audio06/it_doesn't_cost_this_money.wav");
const audio06 = new Audio("audio06/he_doesn't_eat_meat.wav");
const audio07 = new Audio("audio06/it_doesn't_interest_him.wav");
const audio08 = new Audio("audio06/it_doesn't_interest_me.wav");
const audio09 = new Audio("audio06/he_doesn't_have_children.wav");
const audio10 = new Audio("audio06/i_have_some_plans.wav");

const answersArray = [
  ["У меня нет каких-либо планов", "У меня нет каких-либо планов"],
  ["Она не ест эту еду", "Она эту еду не ест"],
  ["У него нет каких-либо вопросов", "У него нет каких-либо вопросов"],
  ["Ей не нравится это место", "Ей это место не нравится"],
  ["Это не стоит этих денег", "Это не стоит этих денег"],
  ["Он не ест мясо", "Он мясо не ест"],
  ["Это не интересует его", "Это его не интересует"],
  ["Это не интересует меня", "Это меня не интересует"],
  ["У него нет детей", "У него детей нет"],
  ["У меня есть некоторые планы", "У меня есть некоторые планы"]
];
