...
const audio01 = new Audio("audio05/i_use_this_service.wav");
const audio02 = new Audio("audio05/i_have_some_interesting_ideas.wav");
const audio03 = new Audio("audio05/it_doesn't_interest_them.wav");
const audio04 = new Audio("audio05/she_doesn't_have_children.wav");
const audio05 = new Audio("audio05/i_use_the_internet_every_day.wav");
const audio06 = new Audio("audio05/he_doesn't_like_it.wav");
const audio07 = new Audio("audio05/it_doesn't_help_us.wav");
const audio08 = new Audio("audio05/she_doesn't_think_so.wav");
const audio09 = new Audio("audio05/she_doesn't_agree.wav");
const audio10 = new Audio("audio05/it_doesn't_motivate_them.wav");
const audio11 = new Audio("audio05/i_don't_eat_it.wav");
const audio12 = new Audio("audio05/he_doesn't_control_this_situation.wav");
const audio13 = new Audio("audio05/it_doesn't_motivate_me.wav");
const audio14 = new Audio("audio05/it_doesn't_help_me.wav");
const audio15 = new Audio("audio05/it_doesn't_interest_her.wav");
...
const answersArray = [
  ...
  "She doesn't agree",
  "It doesn't motivate them",
  "I don't eat it",
  "He doesn't control this situation",
