...
const audio01 = new Audio("audio08/he_needs_that_thing.wav");
const audio02 = new Audio("audio08/he_doesn't_want_to_work.wav");
const audio03 = new Audio("audio08/i_really_like_this_game.wav");
const audio04 = new Audio("audio08/i_want_to_live_in_another_place.wav");
const audio05 = new Audio("audio08/she_doesn't_want_to_study.wav");
const audio06 = new Audio("audio08/i_need_your_help.wav");
const audio07 = new Audio("audio08/she_doesn't_want_to_study_abroad.wav");
const audio08 = new Audio("audio08/he_really_likes_this_website.wav");
const audio09 = new Audio("audio08/he_teaches_english_very_professionally.wav");
const audio10 = new Audio("audio08/she_doesn't_feel_better.wav");
