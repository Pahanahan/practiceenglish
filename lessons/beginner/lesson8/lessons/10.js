...
const audio01 = new Audio("audio10/i_don't_want_to_speak_english_with_mistakes.wav");
const audio02 = new Audio("audio10/we_feel_very_happy_together.wav");
const audio03 = new Audio("audio10/he_feels_happy.wav");
const audio04 = new Audio("audio10/i_prefer_tea.wav");
const audio05 = new Audio("audio10/i_remember_it.wav");

const answersArray = [
  ["Я не хочу говорить по-английски с ошибками", "Я не хочу говорить по-английски с ошибками"],
  ["Мы чувствуем себя очень счастливыми вместе", "Мы чувствуем себя очень счастливыми вместе"],
  ["Он чувствует себя счастливым", "Он себя чувствует счастливым"],
  ["Я предпочитаю чай", "Я предпочитаю чай"],
  ["Я помню это", "Я это помню"],
];
