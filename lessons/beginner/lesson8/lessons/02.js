...
const audio01 = new Audio("audio02/good.wav");
const audio02 = new Audio("audio02/address.wav");
const audio03 = new Audio("audio02/again.wav");
const audio04 = new Audio("audio02/bad.wav");
const audio05 = new Audio("audio02/get.wav");
const audio06 = new Audio("audio02/another.wav");
const audio07 = new Audio("audio02/name.wav");
const audio08 = new Audio("audio02/communicate.wav");
const audio09 = new Audio("audio02/because.wav");
