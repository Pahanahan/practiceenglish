...
const audio01 = new Audio("audio06/i_feel_good.wav");
const audio02 = new Audio("audio06/he_studies.wav");
const audio03 = new Audio("audio06/he_doesn't_teach_english.wav");
const audio04 = new Audio("audio06/she_doesn't_need_our_help.wav");
const audio05 = new Audio("audio06/she_often_makes_mistakes.wav");
const audio06 = new Audio("audio06/i_don't_need_it.wav");
const audio07 = new Audio("audio06/she_doesn't_think_so.wav");
const audio08 = new Audio("audio06/she_doesn't_need_it.wav");
const audio09 = new Audio("audio06/i_need_more_free_time.wav");
const audio10 = new Audio("audio06/i_have_one_question.wav");

const answersArray = [
  ["Я чувствую себя хорошо", "Я себя чувтсвую хорошо"],
  ["Он учится", "Он учится"],
  ["Он не преподает английский", "Он не преподает английский"],
  ["Ей не нужна наша помощь", "Ей наша помощь не нужна"],
  ["Она часто делает ошибки", "Она часто ошибки делает"],
  ["Мне не нужно это", "Мне это не нужно"],
  ["Она не думает так", "Она так не думает"],
  ["Ей не нужно это", "Ей это не нужно"],
  ["Мне нужно больше свободного времени", "Мне нужно больше свободного времени"],
  ["У меня есть один вопрос", "У меня один вопрос есть"]
];
