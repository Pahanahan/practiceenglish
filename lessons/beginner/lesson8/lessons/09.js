...
const audio01 = new Audio("audio09/she_speaks_english_with_mistakes.wav");
const audio02 = new Audio("audio09/she_doesn't_want_to_get_so_little_money.wav");
const audio03 = new Audio("audio09/he_plays_computer_games.wav");
const audio04 = new Audio("audio09/i_don't_like_those_exercises.wav");
const audio05 = new Audio("audio09/i_don't_remember_how_it_works.wav");
const audio06 = new Audio("audio09/he_doesn't_remember_his_address.wav");
const audio07 = new Audio("audio09/i_feel_so_happy_because_i_have_good_results.wav");
const audio08 = new Audio("audio09/he_wants_to_speak_english_without_mistakes.wav");
const audio09 = new Audio("audio09/i_want_to_get_more_money.wav");
const audio10 = new Audio("audio09/he_does_it_again_and_again.wav");

const answersArray = [
  "She speaks English with mistakes",
  "She doesn't want to get so little money",
  "He plays computer games",
  "I don't like those exercises",
  "I don't remember how it works",
  "He doesn't remember his address",
  "I feel so happy because I have good results",
  "He wants to speak English without mistakes",
