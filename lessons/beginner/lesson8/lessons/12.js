...
const audio01 = new Audio("audio12/he_doesn't_speak_english_slowly.wav");
const audio02 = new Audio("audio12/he_speaks_english_very_fast.wav");
const audio03 = new Audio("audio12/she_says_it_again_and_again.wav");
const audio04 = new Audio("audio12/she_has_another_problem.wav");
const audio05 = new Audio("audio12/i_don't_go_there_because_i_have_too_little_free_time.wav");
const audio06 = new Audio("audio12/they_don't_feel_happy.wav");
const audio07 = new Audio("audio12/he_has_a_problem.wav");
const audio08 = new Audio("audio12/he_wants_to_get_more_money.wav");
const audio09 = new Audio("audio12/i_want_to_communicate_with_other_people_who_speak_english.wav");
const audio10 = new Audio("audio12/i_want_to_play_another_game.wav");
