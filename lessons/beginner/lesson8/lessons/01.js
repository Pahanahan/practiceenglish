...
const audio01 = new Audio("audio01/prefer.wav");
const audio02 = new Audio("audio01/need.wav");
const audio03 = new Audio("audio01/remember.wav");
const audio04 = new Audio("audio01/professionally.wav");
const audio05 = new Audio("audio01/other.wav");
const audio06 = new Audio("audio01/website.wav");
const audio07 = new Audio("audio01/fast.wav");
const audio08 = new Audio("audio01/slowly.wav");
const audio09 = new Audio("audio01/who.wav");
