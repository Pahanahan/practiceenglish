...
const audio01 = new Audio("audio02/cat.wav");
const audio02 = new Audio("audio02/maths.wav");
const audio03 = new Audio("audio02/plan.wav");
const audio04 = new Audio("audio02/friend.wav");
const audio05 = new Audio("audio02/use.wav");
const audio06 = new Audio("audio02/dog.wav");
const audio07 = new Audio("audio02/interest.wav");
