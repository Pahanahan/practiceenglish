...
const audio01 = new Audio("audio12/she_doesn't_want_to_call_him.wav");
const audio02 = new Audio("audio12/he_has_a_cat.wav");
const audio03 = new Audio("audio12/he_doesn't_want_to_pay_for_it.wav");
const audio04 = new Audio("audio12/i_don't_worry.wav");
const audio05 = new Audio("audio12/i_don't_worry_about_this_thing.wav");
const audio06 = new Audio("audio12/he_likes_these_tests.wav");
const audio07 = new Audio("audio12/he_doesn't_do_business.wav");
const audio08 = new Audio("audio12/he_doesn't_want_to_talk_about_it.wav");
const audio09 = new Audio("audio12/i_think_it_costs_much_more.wav");
const audio10 = new Audio("audio12/he_doesn't_go_to_work.wav");
