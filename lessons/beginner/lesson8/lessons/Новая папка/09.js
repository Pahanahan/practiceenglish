...
const audio01 = new Audio("audio09/she_doesn't_want_to_sell_her_apartment.wav");
const audio02 = new Audio("audio09/he_doesn't_feel_better.wav");
const audio03 = new Audio("audio09/he_doesn't_have_a_dog.wav");
const audio04 = new Audio("audio09/i_don't_like_exams.wav");
const audio05 = new Audio("audio09/she_has_a_dog.wav");
const audio06 = new Audio("audio09/i_don't_think_that_it_helps.wav");
const audio07 = new Audio("audio09/she_teaches_maths.wav");
const audio08 = new Audio("audio09/i_don't_think_that_it_really_helps_me.wav");
const audio09 = new Audio("audio09/i_don't_worry_about_it.wav");
const audio10 = new Audio("audio09/i_like_this_test.wav");

const answersArray = [
  "She doesn't want to sell her apartment",
