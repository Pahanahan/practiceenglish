...
const stringsArray2 = [stringChoice8, stringChoice9, stringChoice10];
const stringsArray3 = [
  stringChoice11,
  stringChoice12,
  stringChoice13,
...
const stringsArrays = [stringsArray, stringsArray2, stringsArray3];
...
const audio01 = new Audio("audio04/i_want_to_work_in_another_place.wav");
const audio02 = new Audio("audio04/i_need_it.wav");
const audio03 = new Audio("audio04/she_doesn't_need_it.wav");
