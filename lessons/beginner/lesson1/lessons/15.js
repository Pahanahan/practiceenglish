...
const audio01 = new Audio("audio15/we_like_this_language.wav");
const audio02 = new Audio("audio15/i_like_this_song.wav");
const audio03 = new Audio("audio15/i_often_play_this_game.wav");
const audio04 = new Audio("audio15/i_also_think_so.wav");
const audio05 = new Audio("audio15/i_like_travelling.wav");
const audio06 = new Audio("audio15/i_can_help_you.wav");
const audio07 = new Audio("audio15/they_think_so.wav");
const audio08 = new Audio("audio15/i_want_more_practice.wav");
const audio09 = new Audio("audio15/i_often_see_these_things.wav");
const audio10 = new Audio("audio15/they_often_play_football.wav");
