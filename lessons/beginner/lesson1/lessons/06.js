...
const audio01 = new Audio("audio06/i_study.wav");
const audio02 = new Audio("audio06/i_like_this_video.wav");
const audio03 = new Audio("audio06/i_like_this_program.wav");
const audio04 = new Audio("audio06/we_understand_you.wav");
const audio05 = new Audio("audio06/i_see_you.wav");
const audio06 = new Audio("audio06/you_help_me.wav");
const audio07 = new Audio("audio06/i_understand.wav");
const audio08 = new Audio("audio06/i_work_and_study.wav");
const audio09 = new Audio("audio06/i_see_my_result.wav");
const audio10 = new Audio("audio06/i_understand_this_lesson.wav");

const answersArray = [
  ["Я учусь", "Я учусь"],
  ["Мне нравится это видео", "Мне это видео нравится"],
  ["Мне нравится эта программа", "Мне эта программа нравится"],
  ["Мы понимаем тебя", "Мы тебя понимаем"],
  ["Я вижу тебя", "Я тебя вижу"],
  ["Ты помогаешь мне", "Ты мне помогаешь"],
  ["Я понимаю", "Я понимаю"],
  ["Я работаю и учусь", "Я учусь и работаю"],
  ["Я вижу свой результат", "Я результат свой вижу"],
  ["Я понимаю этот урок", "Я этот урок понимаю"],
];
