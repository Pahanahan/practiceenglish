...
const audio01 = new Audio("audio08/we_live_in_this_city.wav");
const audio02 = new Audio("audio08/you_speak_english_very_well.wav");
const audio03 = new Audio("audio08/i_know_it_very_well.wav");
const audio04 = new Audio("audio08/i_speak_russian.wav");
const audio05 = new Audio("audio08/i_like_this_place.wav");
const audio06 = new Audio("audio08/i_see_it_very_well.wav");
const audio07 = new Audio("audio08/i_can_speak_english.wav");
const audio08 = new Audio("audio08/you_really_help_me.wav");

const audio09 = new Audio("audio08/i_really_understand_this_lesson.wav");

const audio10 = new Audio("audio08/i_really_want_it.wav");
