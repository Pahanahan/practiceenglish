...
const audio01 = new Audio("audio07/i_see_my_results.wav");
const audio02 = new Audio("audio07/i_want_it.wav");
const audio03 = new Audio("audio07/i_know_it.wav");
const audio04 = new Audio("audio07/i_like_this_city.wav");
const audio05 = new Audio("audio07/i_work.wav");
