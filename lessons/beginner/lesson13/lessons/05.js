...
const audio01 = new Audio("audio05/it_is_one_million.wav");
const audio02 = new Audio("audio05/it_is_one_million_dollars.wav");
const audio03 = new Audio("audio05/i_am_happy.wav");
const audio04 = new Audio("audio05/it_is_little.wav");
const audio05 = new Audio("audio05/they_are_at_school.wav");
const audio06 = new Audio("audio05/i_am_from_ukraine.wav");
const audio07 = new Audio("audio05/it_is_too_little.wav");
const audio08 = new Audio("audio05/you_are_absolutely_right.wav");
const audio09 = new Audio("audio05/he_is_from_england.wav");
const audio10 = new Audio("audio05/it_is_wonderful.wav");
const audio11 = new Audio("audio05/it_is_so_boring.wav");
const audio12 = new Audio("audio05/it_is_really_wonderful.wav");
const audio13 = new Audio("audio05/he_is_very_happy.wav");
const audio14 = new Audio("audio05/i_am_at_work.wav");
const audio15 = new Audio("audio05/it_is_bad.wav");

const answersArray = [
  "It is one million",
  "It is one million dollars",
  "I am happy",
  "It is little",
  "They are at school",
  "I am from Ukraine",
