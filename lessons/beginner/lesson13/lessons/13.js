...
const audio01 = new Audio("audio13/he_is_sure_we_are_sure.wav");
const audio02 = new Audio(
  "audio13/he_is_absolutely_sure_i_am_absolutely_right.wav"
);
const audio03 = new Audio("audio13/i_am_a_singer_they_are_singers.wav");
const audio04 = new Audio(
  "audio13/he_is_really_sure_you_are_absolutely_right.wav"
);
const audio05 = new Audio("audio13/i_am_a_doctor_they_are_doctors.wav");
const audio06 = new Audio(
  "audio13/he_is_forty_years_old_i_am_sixty_years_old.wav"
);
const audio07 = new Audio("audio13/they_are_friends_this_is_a_boy.wav");
const audio08 = new Audio("audio13/he_is_a_child_we_are_children.wav");
const audio09 = new Audio("audio13/it_is_too_little_they_are_too_big.wav");
const audio10 = new Audio(
  "audio13/he_is_absolutely_right_we_are_really_sure.wav"
);

const answersArray = [
  ["He is sure. We are sure", "We are sure. He is sure"],
  [
    "He is absolutely sure. I am absolutely right",
    "I am absolutely right. He is absolutely sure",
  ],
  ["I am a singer. They are singers", "They are singers. I am a singer"],
  [
    "He is really sure. You are absolutely right",
    "You are absolutely right. He is really sure",
  ],
  ["I am a doctor. They are doctors", "They are doctors. I am a doctor"],
  [
    "He is forty years old. I am sixty years old",
    "I am sixty years old. He is forty years old",
  ],
  ["They are friends. This is a boy", "This is a boy. They are friends"],
  ["He is a child. We are children", "We are children. He is a child"],
  ["It is too little. They are too big", "They are too big. It is too little"],
  [
    "He is absolutely right. We are really sure",
    "We are really sure. He is absolutely right",
  ],
];
