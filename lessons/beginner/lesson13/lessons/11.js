...
const audio01 = new Audio("audio11/she_is_his_wife.wav");
const audio02 = new Audio("audio11/he_is_in_another_country_now.wav");
const audio03 = new Audio("audio11/he_is_sixty.wav");
const audio04 = new Audio("audio11/he_is_a_singer.wav");
const audio05 = new Audio("audio11/they_are_together_now.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
  ["Она его жена", "Она его жена"],
  ["Он в другой стране сейчас", "Он сейчас в другой стране"],
  ["Ему шестьдесят", "Ему шестьдесят"],
  ["Он певец", "Он певец"],
  ["Они вместе сейчас", "Они сейчас вместе"],
];
