...
const audio01 = new Audio("audio06/it_is_very_bad.wav");
const audio02 = new Audio("audio06/it_is_good.wav");
const audio03 = new Audio("audio06/i_am_free.wav");
const audio04 = new Audio("audio06/you_are_right.wav");
const audio05 = new Audio("audio06/he_is_her_husband.wav");
const audio06 = new Audio("audio06/i_am_here.wav");
const audio07 = new Audio("audio06/i_am_at_home.wav");
const audio08 = new Audio("audio06/he_is_angry.wav");
const audio09 = new Audio("audio06/she_is_from_the_united_states.wav");
const audio10 = new Audio("audio06/he_is_very_angry.wav");
...
const answersArray = [
  ...
  ["Я здесь", "Я здесь"],
  ["Я дома", "Я дома"],
  ["Он сердитый", "Он сердитый"],
  ["Она из Соединенных Штатов", "Она из Соединенных Штатов"],
  ["Он очень сердитый", "Он очень сердитый"],
];
