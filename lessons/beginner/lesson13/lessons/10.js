...
const audio01 = new Audio("audio10/he_is_in_his_room.wav");
const audio02 = new Audio("audio10/we_are_students.wav");
const audio03 = new Audio("audio10/they_are_managers.wav");
const audio04 = new Audio("audio10/she_is_in_her_room.wav");
const audio05 = new Audio("audio10/it_is_a_question.wav");

const answersArray = [
  ["Он в своей комнате", "Он в своей комнате"],
  ["Мы студенты", "Мы студенты"],
  ["Они менеджеры", "Они менеджеры"],
  ["Она в своей комнате", "Она в своей комнате"],
