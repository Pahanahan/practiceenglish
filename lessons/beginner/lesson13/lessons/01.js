...
const audio01 = new Audio("audio01/at.wav");
const audio02 = new Audio("audio01/best.wav");
const audio03 = new Audio("audio01/angry.wav");
const audio04 = new Audio("audio01/fact.wav");
const audio05 = new Audio("audio01/husband.wav");
const audio06 = new Audio("audio01/busy.wav");
const audio07 = new Audio("audio01/million.wav");
const audio08 = new Audio("audio01/wonderful.wav");
