...
const stringsArray3 = [stringChoice8, stringChoice9, stringChoice10];
...
const audio01 = new Audio("audio04/i_am_happy.wav");
const audio02 = new Audio("audio04/you_are_absolutely_right.wav");
const audio03 = new Audio("audio04/it_is_wonderful.wav");
