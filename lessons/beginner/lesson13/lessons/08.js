...
const audio01 = new Audio("audio08/it_is_very_interesting.wav");
const audio02 = new Audio("audio08/it_is_very_important.wav");
const audio03 = new Audio("audio08/it_is_so_good.wav");
const audio04 = new Audio("audio08/she_is_really_angry.wav");
const audio05 = new Audio("audio08/i_am_so_happy.wav");
const audio06 = new Audio("audio08/he_is_at_work_now.wav");
const audio07 = new Audio("audio08/i_am_very_busy_now.wav");
const audio08 = new Audio("audio08/we_are_at_home.wav");
const audio09 = new Audio("audio08/i_am_a_student.wav");
const audio10 = new Audio("audio08/they_are_very_busy.wav");
