...
const audio01 = new Audio("audio12/do_you_like_cooking.wav");
const audio02 = new Audio("audio12/does_it_really_motivate_him.wav");
const audio03 = new Audio("audio12/do_you_want_to_see_it_now.wav");
const audio04 = new Audio("audio12/does_he_recommend_this_hotel.wav");
const audio05 = new Audio("audio12/do_you_know_that_person.wav");
const audio06 = new Audio("audio12/do_you_see_a_car.wav");
const audio07 = new Audio("audio12/does_he_feel_better.wav");
const audio08 = new Audio("audio12/do_you_order_it_online.wav");
const audio09 = new Audio("audio12/do_you_prefer_another_food.wav");
const audio10 = new Audio("audio12/do_you_order_food_online.wav");
