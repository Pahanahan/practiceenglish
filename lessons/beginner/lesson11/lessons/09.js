...
const audio01 = new Audio("audio09/do_you_recommend_that_hotel.wav");
const audio02 = new Audio("audio09/do_you_recommend_this_application.wav");
const audio03 = new Audio("audio09/do_you_usually_wake_up_very_late.wav");
const audio04 = new Audio("audio09/does_she_recommend_this_application.wav");
const audio05 = new Audio("audio09/does_he_recommend_it.wav");
const audio06 = new Audio("audio09/do_you_want_to_speak_english_without_mistakes.wav");
const audio07 = new Audio("audio09/does_it_really_interest_her.wav");
const audio08 = new Audio("audio09/does_he_often_visit_you.wav");
const audio09 = new Audio("audio09/does_he_usually_order_it_in_that_shop.wav");
const audio10 = new Audio("audio09/do_you_sometimes_make_mistakes.wav");

const answersArray = [
"Do you recommend that hotel?",
"Do you recommend this application?",
"Do you usually wake up very late?",
"Does she recommend this application?",
"Does he recommend it?",
"Do you want to speak English without mistakes?",
"Does it really interest her?",
"Does he often visit you?",
"Does he usually order it in that shop?",
