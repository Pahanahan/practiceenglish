...
const audio01 = new Audio(
  "audio13/do_you_buy_it_online_do_you_pay_for_it_online.wav"
);
const audio02 = new Audio(
  "audio13/do_you_want_to_get_more_money_does_he_get_enough_money.wav"
);
const audio03 = new Audio(
  "audio13/do_they_want_to_order_it_online_does_she_want_to_buy_it_online.wav"
);
const audio04 = new Audio(
  "audio13/do_you_know_these_children_do_you_know_those_people.wav"
);
const audio05 = new Audio(
  "audio13/does_he_want_to_buy_this_toy_does_he_want_to_order_these_toys.wav"
);
const audio06 = new Audio(
  "audio13/do_you_want_to_dance_does_she_often_cook.wav"
);
const audio07 = new Audio(
  "audio13/do_they_often_wake_up_very_early_do_you_usually_wake_up_late.wav"
);
const audio08 = new Audio(
  "audio13/do_they_usually_buy_expensive_clothes_does_she_usually_order_expensive_clothes.wav"
);
const audio09 = new Audio(
  "audio13/do_you_buy_clothes_online_do_you_pay_for_clothes_online.wav"
);
const audio10 = new Audio(
  "audio13/does_he_want_to_visit_this_city_this_year_does_she_want_to_visit_these_countries_next_year.wav"
);

const answersArray = [
  [
    "Do you buy it online?. Do you pay for it online?",
    "Do you pay for it online?. Do you buy it online?",
  ],
  [
    "Do you want to get more money?. Does he get enough money?",
    "Does he get enough money?. Do you want to get more money?",
  ],
  [
    "Do they want to order it online?. Does she want to buy it online?",
    "Does she want to buy it online?. Do they want to order it online?",
  ],
  [
    "Do you know these children?. Do you know those people?",
    "Do you know those people?. Do you know these children?",
  ],
  [
    "Does he want to buy this toy?. Does he want to order these toys?",
    "Does he want to order these toys?. Does he want to buy this toy?",
  ],
  [
    "Do you want to dance?. Does she often cook?",
    "Does she often cook?. Do you want to dance?",
  ],
  [
    "Do they often wake up very early?. Do you usually wake up late?",
    "Do you usually wake up late?. Do they often wake up very early?",
  ],
  [
    "Do they usually buy expensive clothes?. Does she usually order expensive clothes?",
    "Does she usually order expensive clothes?. Do they usually buy expensive clothes?",
  ],
  [
    "Do you buy clothes online?. Do you pay for clothes online?",
    "Do you pay for clothes online?. Do you buy clothes online?",
  ],
  [
    "Does he want to visit this city this year?. Does she want to visit these countries next year?",
    "Does she want to visit these countries next year?. Does he want to visit this city this year?",
  ],
];
