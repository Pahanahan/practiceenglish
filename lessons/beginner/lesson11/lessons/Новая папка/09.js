...
const audio01 = new Audio("audio09/does_he_buy_very_cheap_things.wav");
const audio02 = new Audio("audio09/does_he_see_them.wav");
const audio03 = new Audio("audio09/does_he_buy_those_things.wav");
const audio04 = new Audio("audio09/does_he_help_you.wav");
const audio05 = new Audio("audio09/do_you_often_listen_to_music.wav");
const audio06 = new Audio("audio09/does_he_feel_that_it_really_helps_him.wav");
const audio07 = new Audio("audio09/do_you_live_together.wav");
const audio08 = new Audio("audio09/does_it_really_interest_you.wav");
const audio09 = new Audio("audio09/does_it_cost_more_than_one_hundred_dollars.wav");
const audio10 = new Audio("audio09/does_he_make_so_many_mistakes.wav");

const answersArray = [
"Does he buy very cheap things?",
"Does he see them?",
"Does he buy those things?",
"Does he help you?",
"Do you often listen to music?",
"Does he feel that it really helps him?",
"Do you live together?",
"Does it really interest you?",
"Does it cost more than one hundred dollars?",
"Does he make so many mistakes?"
];
