...
const audio01 = new Audio("audio11/does_he_have_any_brothers_or_sisters.wav");
const audio02 = new Audio("audio11/does_it_cost_less_than_five_hundred_dollars.wav");
const audio03 = new Audio("audio11/does_she_train_very_intensively.wav");
const audio04 = new Audio("audio11/do_you_often_talk_on_the_phone.wav");
const audio05 = new Audio("audio11/does_she_like_that_music.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
  ["У него есть какие-либо братья или сестры?", "У него есть какие-либо братья или сестры?"],
  ["Это стоит меньше, чем пятьсот долларов?", "Это стоит меньше, чем пятьсот долларов?"],
  ["Она тренируется очень интенсивно?", "Она тренируется очень интенсивно?"],
  ["Ты часто разговариваешь по телефону?", "Ты часто разговариваешь по телефону?"],
  ["Ей нравится та музыка?", "Ей нравится та музыка?"],
];
