...
const audio01 = new Audio("audio07/does_it_help_you.wav");
const audio02 = new Audio("audio07/does_she_have_a_boyfriend.wav");
const audio03 = new Audio("audio07/does_he_look_happy.wav");
const audio04 = new Audio("audio07/do_you_live_far.wav");
const audio05 = new Audio("audio07/does_he_work.wav");
