...
const audio01 = new Audio("audio02/discuss.wav");
const audio02 = new Audio("audio02/from.wav");
const audio03 = new Audio("audio02/actress.wav");
const audio04 = new Audio("audio02/change.wav");
const audio05 = new Audio("audio02/forty.wav");
const audio06 = new Audio("audio02/actor.wav");
const audio07 = new Audio("audio02/one_hundred.wav");
const audio08 = new Audio("audio02/cheap.wav");
const audio09 = new Audio("audio02/five.wav");
const audio10 = new Audio("audio02/expensive.wav");
