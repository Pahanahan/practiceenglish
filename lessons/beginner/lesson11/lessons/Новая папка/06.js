...
const audio01 = new Audio("audio06/does_she_live_in_another_place.wav");
const audio02 = new Audio("audio06/does_it_cost_more.wav");
const audio03 = new Audio("audio06/does_he_like_that_method.wav");
const audio04 = new Audio("audio06/does_it_cost_seven_hundred_euros.wav");
const audio05 = new Audio("audio06/do_you_live_near.wav");
const audio06 = new Audio("audio06/does_it_worry_you.wav");
const audio07 = new Audio("audio06/does_it_seem_very_important.wav");
const audio08 = new Audio("audio06/does_he_have_a_car.wav");
const audio09 = new Audio("audio06/does_it_seem_interesting.wav");
const audio10 = new Audio("audio06/does_she_hav_a_dog.wav");

const answersArray = [
  ["Она живет в другом месте?", "Она в другом живет месте?"],
  ["Это стоит больше?", "Это стоит больше?"],
  ["Ему нравится тот метод?", "Ему нравится тот метод?"],
  ["Это стоит семьсот евро?", "Это семьсот стоит евро?"],
  ["Ты живешь рядом?", "Ты живешь рядом?"],
  ["Тебя это беспокоит?", "Тебя это беспокоит?"],
  ["Это кажется очень важным?", "Это кажется очень важным?"],
  ["У него есть машина?", "У него есть машина?"],
  ["Это кажется интересным?", "Это кажется интересным?"],
