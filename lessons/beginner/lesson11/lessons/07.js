...
const audio01 = new Audio("audio07/do_you_like_your_job.wav");
const audio02 = new Audio("audio07/do_you_get_up_late.wav");
const audio03 = new Audio("audio07/do_you_have_any_pets.wav");
const audio04 = new Audio("audio07/do_you_study_in_one_group.wav");
const audio05 = new Audio("audio07/does_she_get_up_early.wav");
