...
const stringsArrays = [stringsArray, stringsArray2];

const boxLessonsStringsArray = [boxLessonsStrings, boxLessonsStrings2];

const lessonBoxStringsAnswersArray = [lessonBoxStringsAnswer1, lessonBoxStringsAnswer2];

const audio01 = new Audio("audio04/do_you_usually_come_home_late.wav");
const audio02 = new Audio("audio04/does_she_teach_english_professionally.wav");
