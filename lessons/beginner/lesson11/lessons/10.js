...
const audio01 = new Audio("audio10/does_he_see_a_hotel.wav");
const audio02 = new Audio("audio10/do_you_want_to_get_more_money.wav");
const audio03 = new Audio("audio10/do_you_often_cook.wav");
const audio04 = new Audio("audio10/do_you_feel_really_happy.wav");
const audio05 = new Audio("audio10/do_you_like_another_food_more.wav");

const answersArray = [
  ["Он видит отель?", "Он видит отель?"],
  ["Ты хочешь получать больше денег?", "Ты хочешь больше получать денег?"],
  ["Ты часто готовишь?", "Ты часто готовишь?"],
  [
    "Ты действительно чувствуешь себя счастливым?",
    "Ты себя действительно чувствуешь счастливым?",
  ],
  [
    "Тебе нравится больше другая еда?",
    "Тебе больше нравится другая еда?",
  ],
];
