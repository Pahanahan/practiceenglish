...
const audio01 = new Audio("audio06/do_you_see_those_people.wav");
const audio02 = new Audio("audio06/do_you_learn_english_online.wav");
const audio03 = new Audio("audio06/do_you_have_a_cat.wav");
const audio04 = new Audio("audio06/do_you_like_this_profession.wav");
const audio05 = new Audio("audio06/do_you_work_every_day.wav");
const audio06 = new Audio("audio06/do_you_study_in_different_groups.wav");
const audio07 = new Audio("audio06/do_you_often_discuss_these_things.wav");
const audio08 = new Audio("audio06/do_you_need_these_tickets.wav");
const audio09 = new Audio("audio06/does_it_cost_much_more_money.wav");
const audio10 = new Audio("audio06/do_you_have_a_dog.wav");

const answersArray = [
  ["Ты видишь тех людей?", "Ты видишь тех людей?"],
  ["Ты учишь английский онлайн?", "Ты английский учишь онлайн?"],
  ["У тебя есть кот?", "У тебя есть кот?"],
  ["Тебе нравится эта профессия?", "Тебе нравится эта профессия?"],
  ["Ты работаешь каждый день?", "Ты работаешь каждый день?"],
  ["Вы учитесь в разных группах?", "Вы в разных учитесь группах?"],
  ["Вы часто обсуждаете эти вещи?", "Вы обсуждаете часто эти вещи?"],
  ["Тебе нужны эти билеты?", "Тебе нужны эти билеты?"],
  ["Это стоит намного больше денег?", "Это намного больше стоит денег?"],
  ["У тебя есть собака?", "У тебя есть собака?"],
];
