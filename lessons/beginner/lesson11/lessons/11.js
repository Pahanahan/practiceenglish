...
const audio01 = new Audio("audio11/does_it_happen_sometimes.wav");
const audio02 = new Audio("audio11/do_you_want_to_order_a_toy_online.wav");
const audio03 = new Audio("audio11/do_you_have_money_with_you.wav");
const audio04 = new Audio("audio11/do_you_recommend_this_book.wav");
const audio05 = new Audio("audio11/does_it_happen_very_often.wav");

const audioArray = [audio01, audio02, audio03, audio04, audio05];

const answersArray = [
  ["Это случается иногда?", "Это случается иногда?"],
  ["Ты хочешь заказать игрушку онлайн?", "Ты хочешь игрушку заказать онлайн?"],
  ["У тебя есть деньги с собой?", "У тебя деньги есть с собой?"],
  ["Ты рекомендуешь эту книгу?", "Ты рекомендуешь эту книгу?"],
  ["Это случается очень часто?", "Это случается очень часто?"],
];
