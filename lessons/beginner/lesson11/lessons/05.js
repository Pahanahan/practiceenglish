...
const stringChoice104 = document.querySelector(".lesson-learn__block-str104");
const stringChoice105 = document.querySelector(".lesson-learn__block-str105");
const stringChoice106 = document.querySelector(".lesson-learn__block-str106");
const stringChoice107 = document.querySelector(".lesson-learn__block-str107");
const stringChoice108 = document.querySelector(".lesson-learn__block-str108");
const stringChoice109 = document.querySelector(".lesson-learn__block-str109");
const stringChoice110 = document.querySelector(".lesson-learn__block-str110");
const stringChoice111 = document.querySelector(".lesson-learn__block-str111");
const stringChoice112 = document.querySelector(".lesson-learn__block-str112");
const stringChoice113 = document.querySelector(".lesson-learn__block-str113");
const stringChoice114 = document.querySelector(".lesson-learn__block-str114");
const stringChoice115 = document.querySelector(".lesson-learn__block-str115");
const stringChoice116 = document.querySelector(".lesson-learn__block-str116");
const stringChoice117 = document.querySelector(".lesson-learn__block-str117");
const stringChoice118 = document.querySelector(".lesson-learn__block-str118");
const stringChoice119 = document.querySelector(".lesson-learn__block-str119");
const stringChoice120 = document.querySelector(".lesson-learn__block-str120");
const stringChoice121 = document.querySelector(".lesson-learn__block-str121");
const stringChoice122 = document.querySelector(".lesson-learn__block-str122");
const stringChoice123 = document.querySelector(".lesson-learn__block-str123");
const stringChoice124 = document.querySelector(".lesson-learn__block-str124");
const stringChoice125 = document.querySelector(".lesson-learn__block-str125");
const stringChoice126 = document.querySelector(".lesson-learn__block-str126");
const stringChoice127 = document.querySelector(".lesson-learn__block-str127");
const stringChoice128 = document.querySelector(".lesson-learn__block-str128");
const stringChoice129 = document.querySelector(".lesson-learn__block-str129");
const stringChoice130 = document.querySelector(".lesson-learn__block-str130");
const stringChoice131 = document.querySelector(".lesson-learn__block-str131");
const stringChoice132 = document.querySelector(".lesson-learn__block-str132");
const stringChoice133 = document.querySelector(".lesson-learn__block-str133");
const stringChoice134 = document.querySelector(".lesson-learn__block-str134");
const stringChoice135 = document.querySelector(".lesson-learn__block-str135");
...
const answerRightOrNot11 = document.querySelector(
...
const boxLessonsStrings11 = document.querySelector(
  ".lesson-learn__block-strings11"
);
...
const audio01 = new Audio("audio05/do_you_live_in_a_house.wav");
const audio02 = new Audio("audio05/do_you_often_see_him_there.wav");
const audio03 = new Audio("audio05/does_he_understand_you.wav");
const audio04 = new Audio("audio05/does_he_learn_english_here.wav");
const audio05 = new Audio("audio05/does_he_get_up_late.wav");
const audio06 = new Audio("audio05/does_he_study_in_another_group.wav");
const audio07 = new Audio("audio05/do_you_usually_come_home_late.wav");
const audio08 = new Audio("audio05/does_he_come_home_late.wav");
const audio09 = new Audio("audio05/do_they_dance_professionally.wav");
const audio10 = new Audio("audio05/do_you_have_a_pet.wav");
const audio11 = new Audio("audio05/does_he_live_in_that_house.wav");
const audio12 = new Audio("audio05/do_you_have_a_job.wav");
const audio13 = new Audio("audio05/does_she_come_home_early.wav");
const audio14 = new Audio("audio05/does_she_teach_english_professionally.wav");
const audio15 = new Audio("audio05/does_it_work_better.wav");

const answersArray = [
  "Do you live in a house?",
  "Do you often see him there?",
  "Does he understand you?",
  "Does he learn English here?",
  "Does he get up late?",
  "Does he study in another group?",
  "Do you usually come home late?",
  "Does he come home late?",
  "Do they dance professionally?",
  "Do you have a pet?",
  "Does he live in that house?",
  "Do you have a job?",
  "Does she come home early?",
...
let beginner11 = JSON.parse(localStorage.getItem("beginner11"));
...
const saveToLocalStorage = function () {
  localStorage.setItem("beginner11", JSON.stringify(beginner11));
};
