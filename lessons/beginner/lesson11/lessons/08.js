...
const audio01 = new Audio("audio08/do_you_like_your_profession.wav");
const audio02 = new Audio("audio08/does_he_like_his_profession.wav");
const audio03 = new Audio("audio08/does_he_work_more.wav");
const audio04 = new Audio("audio08/do_you_know_these_people.wav");
const audio05 = new Audio("audio08/do_you_get_up_early.wav");
const audio06 = new Audio("audio08/does_he_have_any_pets.wav");
const audio07 = new Audio("audio08/do_you_like_seafood.wav");
const audio08 = new Audio("audio08/does_she_work_less.wav");
const audio09 = new Audio("audio08/do_you_usually_come_home_early.wav");
const audio10 = new Audio("audio08/does_she_dance_professionally.wav");
