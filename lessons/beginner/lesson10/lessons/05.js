...
const audio01 = new Audio("audio05/does_he_live_in_a_house.wav");
const audio02 = new Audio("audio05/does_it_cost_forty_pounds.wav");
const audio03 = new Audio("audio05/does_it_seem_very_strange.wav");
const audio04 = new Audio("audio05/does_it_seem_strange.wav");
const audio05 = new Audio("audio05/does_she_feel_happy.wav");
const audio06 = new Audio("audio05/does_it_really_help_you.wav");
const audio07 = new Audio("audio05/does_he_live_very_far_from_here.wav");
const audio08 = new Audio("audio05/does_it_seem_important.wav");
const audio09 = new Audio("audio05/does_he_have_a_girlfriend.wav");
const audio10 = new Audio("audio05/does_it_cost_three_thousand_pounds.wav");
const audio11 = new Audio("audio05/does_he_live_in_another_country.wav");
const audio12 = new Audio("audio05/does_she_study.wav");
const audio13 = new Audio("audio05/does_he_have_free_time.wav");
const audio14 = new Audio("audio05/do_you_live_near_this_place.wav");
const audio15 = new Audio("audio05/does_it_cost_thirty_euros.wav");

const answersArray = [
  "Does he live in a house?",
  "Does it cost forty pounds?",
