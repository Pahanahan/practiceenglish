...
const audio01 = new Audio("audio06/do_you_watch_tv.wav");
const audio02 = new Audio("audio06/do_you_agree_with_it.wav");
const audio03 = new Audio("audio06/do_i_say_it_correctly.wav");
const audio04 = new Audio("audio06/do_you_play_tennis.wav");
const audio05 = new Audio("audio06/do_you_understand_it.wav");
const audio06 = new Audio("audio06/do_you_often_see_it.wav");
const audio07 = new Audio("audio06/do_you_support_her.wav");
const audio08 = new Audio("audio06/do_you_work.wav");
const audio09 = new Audio("audio06/do_you_like_this_movie.wav");
const audio10 = new Audio("audio06/do_you_really_want_it.wav");

const answersArray = [
  ["Ты смотришь телевизор?", "Ты смотришь телевизор?"],
  ["Ты согласен с этим?", "Ты согласен с этим?"],
  ["Я правильно это говорю?", "Я это правильно говорю?"],
  ["Ты играешь в теннис?", "Ты играешь в теннис?"],
  ["Ты понимаешь это?", "Ты понимаешь это?"],
  ["Ты часто видишь это?", "Ты часто видишь это?"],
  ["Ты поддерживаешь ее?", "Ты поддерживаешь ее?"],
  ["Ты работаешь?", "Ты работаешь?"],
  ["Тебе нравится этот фильм?", "Тебе нравится этот фильм?"],
  ["Ты действительно хочешь это?", "Ты действительно хочешь это?"],
];
