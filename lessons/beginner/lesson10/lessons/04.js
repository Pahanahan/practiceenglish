...
const stringsArrays = [stringsArray];

const boxLessonsStringsArray = [boxLessonsStrings];

const lessonBoxStringsAnswersArray = [lessonBoxStringsAnswer1];

const audio01 = new Audio("audio04/does_he_live_in_that_house.wav");

const answersArray = ["Does he live in that house?"];
