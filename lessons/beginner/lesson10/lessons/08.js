...
const audio01 = new Audio("audio08/do_you_live_in_a_house.wav");
const audio02 = new Audio("audio08/does_she_live_in_an_apartment.wav");
const audio03 = new Audio("audio08/does_it_seem_boring.wav");
const audio04 = new Audio("audio08/does_it_really_worry_you.wav");
const audio05 = new Audio("audio08/does_he_live_near_that_place.wav");
const audio06 = new Audio("audio08/does_he_have_a_cat.wav");
const audio07 = new Audio("audio08/does_he_do_business.wav");
const audio08 = new Audio("audio08/does_it_cost_five_hundred_dollars.wav");
const audio09 = new Audio("audio08/does_it_seem_really_strange.wav");
const audio10 = new Audio("audio08/does_she_like_this_method.wav");
