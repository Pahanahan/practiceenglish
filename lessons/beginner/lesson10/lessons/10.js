...
const audio01 = new Audio("audio10/does_he_help_him.wav");
const audio02 = new Audio("audio10/does_he_want_to_become_an_actor.wav");
const audio03 = new Audio("audio10/do_you_often_spend_time_together.wav");
const audio04 = new Audio("audio10/does_he_work_or_study.wav");
const audio05 = new Audio(
  "audio10/does_it_cost_less_than_two_hundred_dollars.wav"
);

const answersArray = [
  ["Он помогает ему?", "Он помогает ему?"],
  ["Он хочет стать актером?", "Он хочет стать актером?"],
  ["Вы часто проводите время вместе?", "Вы часто время проводите вместе?"],
  ["Он работает или учится?", "Он работает или учится?"],
  [
    "Это стоит меньше, чем двести долларов?",
    "Это стоит меньше, чем двести долларов?",
  ],
];
