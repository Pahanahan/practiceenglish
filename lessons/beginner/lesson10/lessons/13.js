...
const audio01 = new Audio(
  "audio13/do_you_often_call_him_does_she_often_call_them.wav"
);
const audio02 = new Audio(
  "audio13/do_you_buy_very_expensive_things_does_he_buy_a_very_expensive_thing.wav"
);
const audio03 = new Audio(
  "audio13/does_it_motivate_you_does_it_really_motivate_them.wav"
);
const audio04 = new Audio(
  "audio13/does_it_cost_more_than_three_hundred_dollars_does_it_cost_more.wav"
);
const audio05 = new Audio(
  "audio13/do_you_do_different_exercises_does_she_do_different_exercises.wav"
);
const audio06 = new Audio(
  "audio13/do_you_want_to_change_your_job_does_she_want_to_find_a_new_job.wav"
);
const audio07 = new Audio(
  "audio13/do_you_want_to_discuss_it_does_he_want_to_discuss_it.wav"
);
const audio08 = new Audio(
  "audio13/do_they_also_do_it_does_he_also_like_it.wav"
);
const audio09 = new Audio(
  "audio13/do_they_also_think_so_does_she_also_think_so.wav"
);
const audio10 = new Audio(
  "audio13/does_it_interest_them_it_interests_him.wav"
);

const answersArray = [
  [
    "Do you often call him?. Does she often call them?",
    "Does she often call them?. Do you often call him?",
  ],
  [
    "Do you buy very expensive things?. Does he buy a very expensive thing?",
    "Does he buy a very expensive thing?. Do you buy very expensive things?",
  ],
  [
    "Does it motivate you?. Does it really motivate them?",
    "Does it really motivate them?. Does it motivate you?",
  ],
  [
    "Does it cost more than three hundred dollars?. Does it cost more?",
    "Does it cost more?. Does it cost more than three hundred dollars?",
  ],
  [
    "Do you do different exercises?. Does she do different exercises?",
    "Does she do different exercises?. Do you do different exercises?",
  ],
  [
    "Do you want to change your job?. Does she want to find a new job?",
    "Does she want to find a new job?. Do you want to change your job?",
  ],
  [
    "Do you want to discuss it?. Does he want to discuss it?",
    "Does he want to discuss it?. Do you want to discuss it?",
  ],
  [
    "Do they also do it?. Does he also like it?",
    "Does he also like it?. Do they also do it?",
  ],
  [
    "Do they also think so?. Does she also think so?",
    "Does she also think so?. Do they also think so?",
  ],
  [
    "Does it interest them?. It interests him",
    "It interests him. Does it interest them?",
  ],
];
